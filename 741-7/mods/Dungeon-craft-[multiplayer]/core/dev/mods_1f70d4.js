if (config.debug.prohibitedItems) {
    ...
    Item.addCreativeGroup("prohibited", Translation.translate("prohibited"), [BlockID.sap, BlockID.trava, BlockID.a0, BlockID.a1, BlockID.kristaldirt, BlockID.kristalFire, BlockID.kristalwind, BlockID.kristalLight, BlockID.brickkey, BlockID.brick3]);
}
ModAPI.registerAPI("DungeonAPI", {ManaCore: ManaCore, Ritual: Ritual, Debug: Debug, Mp: Mp, ParticlesAPI: ParticlesAPI});
let ac;
ModAPI.addAPICallback("AchievementsAPI", function (api) {
    ...
    api.AchievementAPI.register("DungeonAchievement", {uid: "killBoss0", name: Translation.translate("bloody eye"), description: Translation.translate("kill the boss of the eye"), column: 1, row: 8, type: "challenge", icon: {id: ItemID.glas}});
...
ModAPI.addAPICallback("RecipeViewer", function (api) {
    Callback.addCallback("LevelLoaded", function () {
        ...
        RV.registerRecipeType("ritual1", {title: "\u0440\u0438\u0442\u0443\u0430\u043b \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u044f/ritul create", contents: {icon: BlockID.statua, params: {slot: "_default_slot_light"}, drawing: [], elements: {output0: {x: 440, y: 150, size: 120}, input0: {x: 440, y: 0, size: 120}, input1: {x: 440, y: 300, size: 120}, input2: {x: 590, y: 150, size: 120}, input3: {x: 290, y: 150, size: 120}, textMana: {type: "text", x: 150, y: 350, font: {size: 40}}}}, recipeList: recipeList, onOpen: function (elements, data) {
        ...
        RV.registerRecipeType("ritual2", {title: "\u0440\u0438\u0442\u0443\u0430\u043b \u0443\u043b\u0443\u0447\u0448\u0435\u043d\u0438\u044f/ritul update", contents: {icon: BlockID.rityal1, params: {slot: "_default_slot_light"}, drawing: [{type: "bitmap", x: 410, y: 200, scale: 7.5, bitmap: "furnace_bar_guide"}], elements: {output0: {x: 640, y: 200, size: 120}, input0: {x: 240, y: 200, size: 120}, textMana: {type: "text", x: 400, y: 150, font: {size: 40}}}}, recipeList: recipeList, onOpen: function (elements, data) {
        ...
        for (var g in keys) {
            ...
            for (var i in Ritual.obj3[key].arr) {
                recipeList.push({input: [{id: parseInt(key), data: 0}], output: [{id: Ritual.obj3[key].arr[i], count: 1, data: 0}]});
            }
        }
        RV.registerRecipeType("ritual3", {title: "\u0440\u0438\u0442\u0443\u0430\u043b \u0437\u0430\u0447\u0430\u0440\u043e\u0432\u0430\u043d\u0438\u0435/ritul enchantment", contents: {icon: BlockID.rityal1, params: {slot: "_default_slot_light"}, drawing: [{type: "bitmap", x: 410, y: 200, scale: 7.5, bitmap: "furnace_bar_guide"}], elements: {output0: {x: 640, y: 200, size: 120}, input0: {x: 240, y: 200, size: 120}, textMana: {type: "text", x: 400, y: 150, font: {size: 40}}}}, recipeList: recipeList, onOpen: function (elements, data) {
        ...
        RV.registerRecipeType("tradeAngel", {title: "\u0442\u043e\u0440\u0433\u043e\u0432\u043b\u044f/trade", contents: {icon: 388, params: {slot: "_default_slot_light"}, drawing: [{type: "bitmap", x: 410, y: 200, scale: 7.5, bitmap: "furnace_bar_guide"}], elements: {output0: {x: 640, y: 200, size: 120}, input0: {x: 240, y: 200, size: 120}}}, recipeList: recipeList});
    });
});
