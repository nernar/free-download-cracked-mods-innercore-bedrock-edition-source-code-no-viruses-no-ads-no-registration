...
var PizdecLibb = {setTool: function (id, toolMaterial, ToolTypee, brokenId) {
    ...
    if (id == 89) {
        return [[348, randomInt(2, 4), 0]];
    }
    if (id == 93 || id == 94) {
        return [[356, 1, 0]];
    }
    if (id == 103) {
        return [[360, randomInt(3, 7), 0]];
    }
    if (id == 123 || id == 124) {
        return [[123, 1, 0]];
    }
    ...
    Block.registerPopResourcesFunctionForID(numericID, function (coords, block, f, i) {
        if (Math.random() < 0.25) {
            ...
            for (var i in drop) {
                World.drop(coords.x + 0.5, coords.y + 0.5, coords.z + 0.5, drop[i][0], drop[i][1], drop[i][2]);
            }
        }
    });
}};
...
var MultiTools = {addItem: function (id, material, repairIds) {
    ...
    Item.addCreativeGroup("MultiTools", Translation.translate("MultiTools"), [ItemID[id + "MultiTool"]]);
    Recipes.addShaped({id: ItemID[id + "MultiTool"], count: 1, data: 0}, ["abc", "dfe", " f "], ["a", VanillaItemID[(id).toLowerCase() + (id == "Wood" || id == "Gold" ? "en" : "") + "_pickaxe"], 0, "b", VanillaItemID[(id).toLowerCase() + (id == "Wood" || id == "Gold" ? "en" : "") + "_axe"], 0, "c", VanillaItemID[(id).toLowerCase() + (id == "Wood" || id == "Gold" ? "en" : "") + "_sword"], 0, "d", VanillaItemID[(id).toLowerCase() + (id == "Wood" || id == "Gold" ? "en" : "") + "_hoe"], 0, "e", VanillaItemID[(id).toLowerCase() + (id == "Wood" || id == "Gold" ? "en" : "") + "_shovel"], 0, "f", VanillaItemID.stick, 0]);
}};
let multitool = {enchantType: Native.EnchantType.all, damage: 4, blockTypes: ["fibre", "plant", "dirt", "stone", "wood"], calcDestroyTime: function (item, coords, block, params, destroyTime, enchant) {
    if (block.id == 30) {
        return 0.08;
    }
    if (block.id == 35) {
    ...
    if (block.id == 2) {
        ...
        World.playSound(coords.x + 0.5, coords.y + 1, coords.z + 0.5, "dig.grass", 0.5, 0.8);
...
let multitoolUnbreakable = {enchantType: Native.EnchantType.all, damage: 4, blockTypes: ["fibre", "plant", "dirt", "stone", "wood"], calcDestroyTime: function (item, coords, block, params, destroyTime, enchant) {
    if (block.id == 30) {
        return 0.08;
    }
    if (block.id == 35) {
...
Item.addCreativeGroup("MultiTools", Translation.translate("MultiTools"), [ItemID["Star" + "MultiTool"]]);
PizdecLibb.setTool(ItemID["Star" + "MultiTool"], "netherite", multitoolUnbreakable);
Recipes.addShaped({id: ItemID.StarMultiTool, count: 1, data: Item.getMaxDamage(ItemID.StarMultiTool)}, ["ab"], ["a", ItemID.NetheriteMultiTool, -1, "b", 763, 0]);
...
ModAPI.addAPICallback("OresAPI", function (api) {
    ...
    Item.addCreativeGroup("MultiTools", Translation.translate("MultiTools"), [ItemID["Adamantite" + "MultiTool"]]);
    PizdecLibb.setTool(ItemID["Adamantite" + "MultiTool"], "adamantite", multitool);
    Recipes.addShaped({id: ItemID.AdamantiteMultiTool, count: 1, data: 0}, ["abc", "def", " e "], ["a", ItemID.adamantiteSword, 0, "b", ItemID.adamantitePickaxe, 0, "c", ItemID.adamantiteAxe, 0, "d", ItemID.adamantiteHoe, 0, "e", VanillaItemID.stick, 0, "f", ItemID.adamantiteShovel, 0]);
    ...
    Item.addCreativeGroup("MultiTools", Translation.translate("MultiTools"), [ItemID["Lead" + "MultiTool"]]);
    PizdecLibb.setTool(ItemID["Lead" + "MultiTool"], "lead", multitool);
    Recipes.addShaped({id: ItemID.LeadMultiTool, count: 1, data: 0}, ["abc", "def", " e "], ["a", ItemID.leadSword, 0, "b", ItemID.leadPickaxe, 0, "c", ItemID.leadAxe, 0, "d", ItemID.leadHoe, 0, "e", VanillaItemID.stick, 0, "f", ItemID.leadShovel, 0]);
    ...
    Item.addCreativeGroup("MultiTools", Translation.translate("MultiTools"), [ItemID["Malachite" + "MultiTool"]]);
    PizdecLibb.setTool(ItemID["Malachite" + "MultiTool"], "malachite", multitool);
    Recipes.addShaped({id: ItemID.MalachiteMultiTool, count: 1, data: 0}, ["abc", "def", " e "], ["a", ItemID.malachiteSword, 0, "b", ItemID.malachitePickaxe, 0, "c", ItemID.malachiteAxe, 0, "d", ItemID.malachiteHoe, 0, "e", VanillaItemID.stick, 0, "f", ItemID.malachiteShovel, 0]);
    ...
    Item.addCreativeGroup("MultiTools", Translation.translate("MultiTools"), [ItemID["Uranium" + "MultiTool"]]);
    PizdecLibb.setTool(ItemID["Uranium" + "MultiTool"], "uranium", multitool);
    Recipes.addShaped({id: ItemID.UraniumMultiTool, count: 1, data: 0}, ["abc", "def", " e "], ["a", ItemID.uraniumSword, 0, "b", ItemID.uraniumPickaxe, 0, "c", ItemID.uraniumAxe, 0, "d", ItemID.uraniumHoe, 0, "e", VanillaItemID.stick, 0, "f", ItemID.uraniumShovel, 0]);
...
ModAPI.addAPICallback("ICore", function (api) {
    ...
    Item.addCreativeGroup("MultiTools", Translation.translate("MultiTools"), [ItemID["Bronze" + "MultiTool"]]);
    PizdecLibb.setTool(ItemID["Bronze" + "MultiTool"], "bronze", multitool);
    Recipes.addShaped({id: ItemID.BronzeMultiTool, count: 1, data: 0}, ["abc", "def", " e "], ["a", ItemID.bronzeSword, 0, "b", ItemID.bronzePickaxe, 0, "c", ItemID.bronzeAxe, 0, "d", ItemID.bronzeHoe, 0, "e", VanillaItemID.stick, 0, "f", ItemID.bronzeShovel, 0]);
