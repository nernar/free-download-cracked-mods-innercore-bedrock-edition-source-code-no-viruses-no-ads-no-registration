...
Block.createBlock("oreFluorite", [{name: "Fluorite Ore", texture: [["ore_fluorite", 0]], inCreative: true}], BLOCK_LIGHT_O);
...
Block.createBlock("oreCopper", [{name: "Copper Ore", texture: [["ore_copper", 0]], inCreative: true}], "opaque");
Block.setDestroyTime(BlockID.oreCopper, 2);
ToolAPI.registerBlockMaterial(BlockID.oreCopper, "stone", 2, true);
IDRegistry.genBlockID("oreTin");
Block.createBlock("oreTin", [{name: "Tin ore", texture: [["ore_tin", 0]], inCreative: true}], "opaque");
...
Block.createBlock("oreRuby", [{name: "Ruby Ore", texture: [["ore_ruby", 0]], inCreative: true}], BLOCK_LIGHT_O);
