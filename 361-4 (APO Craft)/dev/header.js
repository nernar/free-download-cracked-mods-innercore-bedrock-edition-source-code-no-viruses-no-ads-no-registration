...
var BLOCK_LIGHT_O = Block.createSpecialType({lightlevel: 7, opaque: true});
var BLOCK_HARD = Block.createSpecialType({explosionres: 2000});
var DEBUG = __config__.getBool("debug_mode");
var inCity = false;
Saver.addSavesScope("inCity", function read(scope) {
...
function getSideCoords(coords) {
    return [{x: coords.x, y: coords.y + 1, z: coords.z}, {x: coords.x, y: coords.y - 1, z: coords.z}, {x: coords.x + 1, y: coords.y, z: coords.z}, {x: coords.x - 1, y: coords.y, z: coords.z}, {x: coords.x, y: coords.y, z: coords.z + 1}, {x: coords.x, y: coords.y, z: coords.z - 1}];
}
