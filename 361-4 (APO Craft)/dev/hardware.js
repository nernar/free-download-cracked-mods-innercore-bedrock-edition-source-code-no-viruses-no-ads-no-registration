...
RecipesManager.addShaped({id: ItemID.headMagnetic, count: 1, data: 0}, ["   ", "aaa", "ccb"], ["a", ItemID.rodTitanium, 0, "b", ItemID.coilCopper, 0, "c", ItemID.cableCopper0, 0]);
IDRegistry.genItemID("diskMagnetic");
Item.createItem("diskMagnetic", "Magnetic Disk", {name: "disk_magnetic", meta: 0}, {});
RecipesManager.addShaped({id: ItemID.diskMagnetic, count: 1, data: 0}, ["aaa", "bbb", "aaa"], ["a", ItemID.dustIron, 0, "b", 102, 0]);
IDRegistry.genItemID("socket");
Item.createItem("socket", "Socket", {name: "socket", meta: 0}, {});
RecipesManager.addShaped({id: ItemID.socket, count: 1, data: 0}, ["bbb", "aaa", "bbb"], ["b", ItemID.platePolypropylene, 0, "a", ItemID.cableCopper0, 0]);
