var GunRegistry = {guns: [], bullets: [], hurt: [], inGame: false, registerGun: function (gun) {
    gun.shooting = false;
    ...
    if (PlayerInventory.retrieveItem(gun.bullet)) {
        ...
        let velocity = {x: -Math.sin(lookAngle.yaw) * gun.speed, y: Math.sin(lookAngle.pitch) * gun.speed, z: Math.cos(lookAngle.yaw) * gun.speed};
    ...
    if (GunRegistry.aimShown || !GunRegistry.inGame) {
        return;
    }
    runAsUI(function () {
