...
RecipesManager.addShaped({id: ItemID.helmetCan, count: 1, data: 0}, ["aaa", "a a", "   "], ["a", ItemID.can, 0]);
RecipesManager.addShaped({id: ItemID.chestplateCan, count: 1, data: 0}, ["a a", "aaa", "aaa"], ["a", ItemID.can, 0]);
RecipesManager.addShaped({id: ItemID.leggingsCan, count: 1, data: 0}, ["a a", "a a", "a a"], ["a", ItemID.can, 0]);
RecipesManager.addShaped({id: ItemID.bootsCan, count: 1, data: 0}, ["   ", "a a", "a a"], ["a", ItemID.can, 0]);
...
RecipesManager.addShaped({id: ItemID.hazmatHelmetApo, count: 1, data: 0}, ["xxx", "xbx"], ["x", ItemID.clothHazmat, 0, "b", ItemID.hazmatMask, 0]);
RecipesManager.addShaped({id: ItemID.hazmatChestplateApo, count: 1, data: 0}, ["x x", "xxx", "xxx"], ["x", ItemID.clothHazmat, 0]);
RecipesManager.addShaped({id: ItemID.hazmatLeggingsApo, count: 1, data: 0}, ["xxx", "x x", "x x"], ["x", ItemID.clothHazmat, 0]);
RecipesManager.addShaped({id: ItemID.hazmatBootsApo, count: 1, data: 0}, ["x x", "x x"], ["x", ItemID.clothHazmat, 0]);
