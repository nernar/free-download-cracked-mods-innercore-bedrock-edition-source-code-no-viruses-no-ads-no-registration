...
GunRegistry.registerGun({gun: ItemID.glock18, bullet: ItemID.bullet_9_19, skin: "mob/bullet.png", speed: 8, damage: 15, aim: BitmapFactory.decodeFile(__dir__ + "gui/aim.png")});
GunRegistry.registerGun({gun: ItemID.deserteagle, bullet: ItemID.bullet_9_19, skin: "mob/bullet.png", speed: 9, damage: 20, aim: BitmapFactory.decodeFile(__dir__ + "gui/aim.png")});
GunRegistry.registerGun({gun: ItemID.rsh_12, bullet: ItemID.bullet_12c7_55, skin: "mob/bullet.png", speed: 16, damage: 40, aim: BitmapFactory.decodeFile(__dir__ + "gui/aim.png"), fov: 50});
GunRegistry.registerGun({gun: ItemID.barrett, bullet: ItemID.ammo_sniper, skin: "mob/bullet.png", speed: 21, damage: 42, aim: BitmapFactory.decodeFile(__dir__ + "gui/aim_round.png"), fov: 50});
GunRegistry.registerGun({gun: ItemID.sg_556, bullet: ItemID.bullet_5c56_45, skin: "mob/bullet.png", speed: 16, damage: 20, aim: BitmapFactory.decodeFile(__dir__ + "gui/aim_round.png"), fov: 20, automatic: 5});
GunRegistry.registerGun({gun: ItemID.aa12, bullet: ItemID.ammo_shotgun, skin: "mob/bullet.png", speed: 18, damage: 24, aim: BitmapFactory.decodeFile(__dir__ + "gui/aim.png"), fov: 20, automatic: 6});
GunRegistry.registerGun({gun: ItemID.ak47, bullet: ItemID.ammo_assault, skin: "mob/bullet.png", speed: 18, damage: 30, aim: BitmapFactory.decodeFile(__dir__ + "gui/aim.png"), fov: 20, automatic: 3});
