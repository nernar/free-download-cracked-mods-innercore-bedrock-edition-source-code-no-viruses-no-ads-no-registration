...
Item.createItem("karambitGradient", "Karambit Gradient", {name: "karambit_gradient", meta: 0}, {stack: 1});
...
Item.createItem("knifeButterfly", "Butterfly", {name: "knife_butterfly", meta: 0}, {stack: 1});
ToolAPI.registerSword(ItemID.knifeButterfly, {level: 0, durability: 1856, damage: 7}, {damage: 7});
IDRegistry.genItemID("swordBig");
Item.createItem("swordBig", "Big Sword", {name: "big_sword", meta: 0}, {stack: 1});
