const RadiatorsManager = {inWorld: {}, ids: {}, addId: function (id) {
    ...
    if (blocks) {
        ...
        for (let xx = -1; xx < 2; xx++) {
            for (let zz = -1; zz < 2; zz++) {
                if (xx == 0 && zz == 0) {
                    ...
                    World.setBlock(x + xx, y, z + zz, blocks[index]);
                }
                index++;
            }
        }
        ...
        Logger.Log("'RadiatorsManager.breakBigRadiator' was called with incorrect coords", "WARNING");
    }
...
Block.createBlock("radiatorIron", [{name: "Iron Radiator", texture: [["iron_block", 0]], inCreative: true}]);
...
Block.createBlock("radiatorGold", [{name: "Gold Radiator", texture: [["gold_block", 0]], inCreative: true}]);
...
Block.createBlock("radiatorTitanium", [{name: "Titanium Radiator", texture: [["block_titanium", 0]], inCreative: true}]);
...
Block.createBlock("radiatorLead", [{name: "Lead Radiator", texture: [["block_lead", 0]], inCreative: true}]);
...
Block.createBlock("radiatorAluminum", [{name: "Aluminum Radiator", texture: [["block_aluminum", 0]], inCreative: true}]);
...
Block.createBlock("radiatorCopper", [{name: "Copper Radiator", texture: [["block_copper", 0]], inCreative: true}]);
...
Block.createBlock("radiatorTin", [{name: "Tin Radiator", texture: [["block_tin", 0]], inCreative: true}]);
...
Block.createBlock("bigRadiator", [{name: "Big Radiator", texture: [["hopper_side", 0]]}]);
...
Saver.addSavesScope("RadiatorsPosition", function read(scope) {
    for (let i in scope) {
