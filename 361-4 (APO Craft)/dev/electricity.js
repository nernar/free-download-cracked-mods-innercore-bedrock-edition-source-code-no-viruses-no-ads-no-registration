...
RecipesManager.addShaped({id: ItemID.storageBattery, count: 1, data: 0}, ["a", "c", "b"], ["a", ItemID.batteryCap, 0, "c", ItemID.nuggetLead, 0, "b", ItemID.batteryCasing, 0]);
...
RecipesManager.addShaped({id: ItemID.storageBatteryAdv, count: 1, data: 0}, ["acb"], ["a", ItemID.plateAlloy, 0, "c", ItemID.storageBattery, 0, "b", ItemID.dustSulfur, 0]);
IDRegistry.genItemID("buttonSet");
Item.createItem("buttonSet", "Button Set", {name: "button_set", meta: 0}, {});
RecipesManager.addShaped({id: ItemID.buttonSet, count: 1, data: 0}, [" a ", "aba", " a "], ["a", 143, 0, "b", 77, 0]);
...
RecipesManager.addShaped({id: ItemID.ledRed, count: 16, data: 0}, [" a ", "cbc", "ede"], ["a", 20, 0, "b", 351, 1, "c", ItemID.platePolypropylene, 0, "d", ItemID.galliumArsenide, 0, "e", ItemID.cableCopper0, 0]);
RecipesManager.addShaped({id: ItemID.ledYellow, count: 16, data: 0}, [" a ", "cbc", "ede"], ["a", 20, 0, "b", 351, 11, "c", ItemID.platePolypropylene, 0, "d", ItemID.galliumArsenide, 0, "e", ItemID.cableCopper0, 0]);
RecipesManager.addShaped({id: ItemID.ledGreen, count: 16, data: 0}, [" a ", "cbc", "ede"], ["a", 20, 0, "b", 351, 2, "c", ItemID.platePolypropylene, 0, "d", ItemID.galliumArsenide, 0, "e", ItemID.cableCopper0, 0]);
IDRegistry.genItemID("capacitor");
Item.createItem("capacitor", "Capacitor", {name: "capacitor", data: 0});
RecipesManager.addShaped({id: ItemID.capacitor, count: 3, data: 0}, ["aaa", "bbb", "aaa"], ["a", ItemID.plateCopper, 0, "b", 336, 0]);
IDRegistry.genItemID("transistor");
Item.createItem("transistor", "Transistor", {name: "transistor", data: 0});
RecipesManager.addShaped({id: ItemID.transistor, count: 1, data: 0}, ["aaa", " a "], ["a", ItemID.galliumArsenide, 0]);
...
RecipesManager.addShaped({id: ItemID.capacitor, count: 3, data: 0}, ["aaa", "bbb", "aaa"], ["a", 336, 0, "b", ItemID.cableLead0, 0]);
IDRegistry.genItemID("smd");
Item.createItem("smd", "SMD Details", {name: "smd", data: 0});
for (var i = ItemID.ledRed; i <= ItemID.ledGreen; i++) {
    RecipesManager.addShapeless({id: ItemID.smd, count: 1, data: 0}, [{id: ItemID.resistor, data: 0}, {id: ItemID.resistor, data: 0}, {id: ItemID.resistor, data: 0}, {id: ItemID.transistor, data: 0}, {id: ItemID.transistor, data: 0}, {id: ItemID.diode, data: 0}, {id: i, data: 0}, {id: ItemID.capacitor, data: 0}, {id: ItemID.capacitor, data: 0}]);
}
IDRegistry.genItemID("transformer");
Item.createItem("transformer", "Transformer", {name: "transformer", data: 0});
RecipesManager.addShaped({id: ItemID.transformer, count: 1, data: 0}, ["aa", "aa"], ["a", ItemID.coilCopper, 0]);
IDRegistry.genItemID("laser");
Item.createItem("laser", "Laser", {name: "laser", data: 0});
RecipesManager.addShaped({id: ItemID.laser, count: 1, data: 0}, [" a ", "aba", " a "], ["a", ItemID.ruby, 0, "b", 331, 0]);
IDRegistry.genItemID("engine");
Item.createItem("engine", "Engine", {name: "engine", data: 0});
RecipesManager.addShaped({id: ItemID.engine, count: 1, data: 0}, ["aba"], ["a", ItemID.coke, 0, "b", ItemID.coilCopper, 0]);
