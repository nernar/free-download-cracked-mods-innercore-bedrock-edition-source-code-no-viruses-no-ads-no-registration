...
RecipesManager.addShaped({id: BlockID.blockTitanium, count: 1, data: 0}, ["aaa", "aaa", "aaa"], ["a", ItemID.ingotTitanium, 0]);
...
RecipesManager.addShaped({id: BlockID.blockLead, count: 1, data: 0}, ["aaa", "aaa", "aaa"], ["a", ItemID.ingotLead, 0]);
IDRegistry.genBlockID("blockAluminum");
Block.createBlock("blockAluminum", [{name: "Aluminum Block", texture: [["block_aluminum", 0]], inCreative: true}], "opaque");
Block.setDestroyTime(BlockID.blockAluminum, 3);
ToolAPI.registerBlockMaterial(BlockID.blockAluminum, "stone", 2, true);
RecipesManager.addShaped({id: BlockID.blockAluminum, count: 1, data: 0}, ["aaa", "aaa", "aaa"], ["a", ItemID.ingotAluminum, 0]);
...
RecipesManager.addShaped({id: BlockID.blockSulfur, count: 1, data: 0}, ["aaa", "aaa", "aaa"], ["a", ItemID.dustSulfur, 0]);
IDRegistry.genBlockID("blockFluorite");
Block.createBlock("blockFluorite", [{name: "Fluorite Block", texture: [["block_fluorite", 0]], inCreative: true}], BLOCK_LIGHT_O);
Block.setDestroyTime(BlockID.blockFluorite, 3);
ToolAPI.registerBlockMaterial(BlockID.blockFluorite, "stone", 2, true);
RecipesManager.addShaped({id: BlockID.blockFluorite, count: 1, data: 0}, ["aaa", "aaa", "aaa"], ["a", ItemID.dustFluorite, 0]);
IDRegistry.genBlockID("blockCopper");
Block.createBlock("blockCopper", [{name: "Copper Block", texture: [["block_copper", 0]], inCreative: true}], "opaque");
Block.setDestroyTime(BlockID.blockCopper, 3);
ToolAPI.registerBlockMaterial(BlockID.blockCopper, "stone", 3, true);
RecipesManager.addShaped({id: BlockID.blockCopper, count: 1, data: 0}, ["aaa", "aaa", "aaa"], ["a", ItemID.ingotCopper, 0]);
...
RecipesManager.addShaped({id: BlockID.blockTin, count: 1, data: 0}, ["aaa", "aaa", "aaa"], ["a", ItemID.ingotTin, 0]);
...
RecipesManager.addShaped({id: BlockID.blockTin, count: 1, data: 0}, ["aaa", "a a", "aaa"], ["a", ItemID.plateIron, 0]);
