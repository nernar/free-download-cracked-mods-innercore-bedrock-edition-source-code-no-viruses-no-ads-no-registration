...
var chemicalScale = new ScalesRPG.Scale({bitmaps: {full: BitmapFactory.decodeFile(__dir__ + "gui/scale_chemical_0.png"), half: BitmapFactory.decodeFile(__dir__ + "gui/scale_chemical_1.png"), empty: BitmapFactory.decodeFile(__dir__ + "gui/scale_chemical_2.png")}, value: 0, defaultValue: 0});
Saver.addSavesScope("ChemicalScaleValue", function read(scope) {
