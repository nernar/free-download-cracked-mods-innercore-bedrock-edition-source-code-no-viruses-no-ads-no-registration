...
Plane.spawn = function (x, z) {
    ...
    animationPlane.loadCustom(function () {
        this.ticks++;
        for (var i = 0; i < 2; i++) {
            Plane.render.setPart(i == 0 ? "airscrew_left" : "airscrew_right", Plane.airscrew, {rotation: {x: 0, y: 0, z: (this.ticks % 500) * 360 / 64}});
        }
...
Plane.airscrew = [{type: "box", coords: {x: 0, y: 0, z: 10}, size: {x: 3, y: 40, z: 1}, uv: {x: 216, y: 10}}, {type: "box", coords: {x: 0, y: 0, z: 10}, size: {x: 40, y: 3, z: 1}, uv: {x: 0, y: 0}}];
(function () {
    var partFuselage = [{type: "box", coords: {x: 0, y: 0, z: 0}, size: {x: 150, y: 2, z: 18}, uv: {x: 0, y: 0}}, {type: "box", coords: {x: -40, y: 0, z: 2}, size: {x: 10, y: 10, z: 14}, uv: {x: 0, y: 0}}, {type: "box", coords: {x: 40, y: 0, z: 2}, size: {x: 10, y: 10, z: 14}, uv: {x: 0, y: 0}}, {type: "box", coords: {x: 0, y: 0, z: -40}, size: {x: 10, y: 10, z: 120}, uv: {x: 0, y: 0}}, {type: "box", coords: {x: 0, y: 0, z: -10}, size: {x: 18, y: 18, z: 50}, uv: {x: 0, y: 0}}, {type: "box", coords: {x: 0, y: -9, z: -10}, size: {x: 14, y: 5, z: 40}, uv: {x: 0, y: 0}}, {type: "box", coords: {x: 0, y: 0, z: -100}, size: {x: 60, y: 2, z: 18}, uv: {x: 0, y: 0}}, {type: "box", coords: {x: 0, y: -15, z: -100}, size: {x: 2, y: 30, z: 18}, uv: {x: 0, y: 0}}];
...
Plane.bomb.customizeEvents({death: function (attacker) {
    let coords = Entity.getPosition(this.entity);
    Entity.remove(this.entity);
}});
Plane.bomb.customizeDescription({getHealth: function () {
    return 1;
}});
Plane.bomb.customizeVisual({getModels: function () {
    return {"main": Plane.bombModel};
}});
