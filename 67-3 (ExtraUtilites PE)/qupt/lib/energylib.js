...
libconfig.checkAndRestore({performance: {lazy_web_rebuild: false}, util: {logger_tag: "ENERGY_LIB"}});
...
var EnergyLib = {getConfig: function () {
    return libconfig;
}};
...
var EnergyRegistry = {energyTypes: {}, createEnergyType: function (name, value, wireParams) {
...
}, wireIds: {}, isWire: function (id, data) {
...
var TileEntityRegistry = {addEnergyType: function (Prototype, energyType) {
...
}, machineIDs: {}, isMachine: function (id) {
    return this.machineIDs[id];
}, quickCoordAccess: {}, addMacineAccessAtCoords: function (x, y, z, machine) {
...
var EnergyWebBuilder = {buildFor: function (tileEntity, type) {
    ...
    return web;
}, energyWebs: [], addEnergyWeb: function (web) {
    ...
    this.rebuildRecursive(web, wireIds, x, y, z + 1, explored);
}, postedRebuildTimer: 0, clearWebData: function () {
    for (var i in this.energyWebs) {
