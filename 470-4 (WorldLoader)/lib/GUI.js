...
var GUI = {test: function (window) {
    ...
    var renderTabs = function () {
        var margin_right = ((settings.texture.window.bitmap.width - settings.texture.window.bitmap.ninePatch.x[settings.texture.window.bitmap.ninePatch.x.length - 1]) * settings.texture.window.bitmap.scale) || GUI.getUnitsInPixels(3);
        var margin_left = (settings.texture.window.bitmap.ninePatch.x[0] * settings.texture.window.bitmap.scale) || GUI.getUnitsInPixels(3);
        top.removeAllViews();
    ...
    this.onCreate = function () {
        ...
        var margin_top = (settings.texture.window.bitmap.ninePatch.y[0] * settings.texture.window.bitmap.scale) || GUI.getUnitsInPixels(3);
        var margin_bottom = ((settings.texture.window.bitmap.height - settings.texture.window.bitmap.ninePatch.y[settings.texture.window.bitmap.ninePatch.y.length - 1]) * settings.texture.window.bitmap.scale) || GUI.getUnitsInPixels(3);
        var margin_left = (settings.texture.window.bitmap.ninePatch.x[0] * settings.texture.window.bitmap.scale) || GUI.getUnitsInPixels(3);
        var margin_right = ((settings.texture.window.bitmap.width - settings.texture.window.bitmap.ninePatch.x[settings.texture.window.bitmap.ninePatch.x.length - 1]) * settings.texture.window.bitmap.scale) || GUI.getUnitsInPixels(3);
        content.setPadding(margin_left + GUI.getUnitsInPixels(10), margin_top + GUI.getUnitsInPixels(10), margin_right + GUI.getUnitsInPixels(10), margin_bottom + GUI.getUnitsInPixels(10));
