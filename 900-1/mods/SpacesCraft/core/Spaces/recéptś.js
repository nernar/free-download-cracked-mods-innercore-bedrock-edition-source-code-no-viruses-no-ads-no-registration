...
SpacesMachine.addCollectorLeave(VanillaBlockID.leaves);
SpacesMachine.addCollectorLeave(VanillaBlockID.leaves2);
SpacesMachine.addCollectorLeave(VanillaBlockID.vic_a2_tantros_leaves);

SpacesMachine.addCoal(VanillaItemID.coal);
SpacesMachine.addCoal(VanillaItemID.charcoal);
SpacesMachine.addCoal(ItemID.burned_coal);
...
SpacesCraft.addSHIFTtext(BlockID.stj_mekanism_block, "Used for create \nindustrial machines")

SpacesCraft.addSHIFTtext(BlockID.mekanism_block_ports, "Used for create \nindustrial machines")

SpacesCraft.addSHIFTtext(BlockID.stj_mekanism_block_ports, "Used for create \nindustrial machines")
...
Recipes.addShaped({id: BlockID.stj_mekanism_block, count: 1, data: 0}, [
    "bab",
    "aca",
    "bab"
], ['a', ItemID.gear_wheel_gravetite, 0, 'b', ItemID.ingot_titanium, 0, 'c', BlockID.block_titanium, 0]);
...
Recipes.addShaped({id: BlockID.mekanism_block_ports, count: 1, data: 0}, [
    ...
    "aba",
    "c  "
], ['a', BlockID.ImprovedAluminumWire, 0, 'b',BlockID.mekanism_block, 0,'c',VanillaBlockID.redstone,0]);
...
Recipes.addShaped({id: ItemID.gear_wheel_gravetite, count: 1, data: 0}, [
    "bab",
    "a a",
    "bab"
], ['a', ItemID.gravetite_ingot, 0, 'b', ItemID.shard_gravetite, 0]);


Recipes.addShaped({id: ItemID.tin_shard, count: 1, data: 0}, [
    "a"
], ['a', ItemID.ingot_tin_sc, 0]);

Recipes.addShaped({id: ItemID.copper_shard, count: 1, data: 0}, [
    "a"
], ['a', ItemID.ingot_copper_sc, 0]);
...
Recipes.addShaped({id: ItemID.aluminum_shard, count: 1, data: 0}, [
    "a"
], ['a', ItemID.ingot_aluminum_sc, 0]);

Recipes.addShaped({id: ItemID.emerald_shard, count: 1, data: 0}, [
    "a"
], ['a', VanillaItemID.emerald, 0]);

Recipes.addShaped({id: ItemID.iron_steel_shard, count: 1, data: 0}, [
    "a"
], ['a', ItemID.iron_steel_ingot, 0]);

Recipes.addShaped({id: ItemID.meteoric_iron_shard, count: 1, data: 0}, [
    "a"
], ['a', ItemID.meteoric_iron_ingot, 0]);

Recipes.addShaped({id: ItemID.shard_titanium, count: 1, data: 0}, [
    "a"
