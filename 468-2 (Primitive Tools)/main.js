...
Item.createItem("verevka_iz_volokna", "Веревка Из Волокна", {name: "веревка_из_волокна"});

IDRegistry.genItemID("verevka_iz_lozy");
Item.createItem("verevka_iz_lozy", "Веревка Из Лозы", {name: "веревка_из_лозы"});

IDRegistry.genItemID("verevka_iz_kozhi");
Item.createItem("verevka_iz_kozhi", "Веревка Из Кожи", {name: "веревка_из_кожи"});

IDRegistry.genItemID("kusok_kremnya");
Item.createItem("kusok_kremnya", "Кусок Кремня", {name: "кусок_кремня"});

IDRegistry.genItemID("oskolok_kremnya");
Item.createItem("oskolok_kremnya", "Осколок Кремня", {name: "осколок_кремня"});

IDRegistry.genItemID("ostryi_kusok_kremnya");
Item.createItem("ostryi_kusok_kremnya", "Острый Кусок Кремня", {name: "острый_кусок_кремня"});

IDRegistry.genItemID("kost_igla");
Item.createItem("kost_igla", "Острая Кость", {name: "кость_игла"}, {stack:1});

IDRegistry.genItemID("rast_volokno");
Item.createItem("rast_volokno", "Растительное Волокно", {name: "растительное_волокно"});
...
Item.createItem("nozh_palka_volokno", "Ножик Из Палки И Волокна", {name: "нож_палка_волокно", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["nozh_palka_volokno"], "palka_volokno", ToolType.sword);



IDRegistry.genItemID("topor_palka_volokno");
Item.createItem("topor_palka_volokno", "Топорик Из Палки И Волокна", {name: "топор_палка_волокно", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["topor_palka_volokno"], "palka_volokno", ToolType.axe);


IDRegistry.genItemID("kirka_palka_volokno");
Item.createItem("kirka_palka_volokno", "Кирка Из Палки И Волокна", {name: "кирка_палка_волокно", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["kirka_palka_volokno"], "palka_volokno", ToolType.pickaxe);


IDRegistry.genItemID("lopata_palka_volokno");
Item.createItem("lopata_palka_volokno", "Лопатка Из Палки И Волокна", {name: "лопата_палка_волокно", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["lopata_palka_volokno"], "palka_volokno", ToolType.shovel);


IDRegistry.genItemID("motyga_palka_volokno");
Item.createItem("motyga_palka_volokno", "Мотыга Из Палки И Волокна", {name: "мотыга_палка_волокно", meta: 0}, {stack: 1});
...
Item.createItem("nozh_palka_loza", "Ножик Из Палки И Лозы", {name: "нож_палка_лоза", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["nozh_palka_loza"], "palka_loza", ToolType.sword);


IDRegistry.genItemID("topor_palka_loza");
Item.createItem("topor_palka_loza", "Топорик Из Палки И Лозы", {name: "топор_палка_лоза", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["topor_palka_loza"], "palka_loza", ToolType.axe);


IDRegistry.genItemID("kirka_palka_loza");
Item.createItem("kirka_palka_loza", "Кирка Из Палки И Лозы", {name: "кирка_палка_лоза", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["kirka_palka_loza"], "palka_loza", ToolType.pickaxe);


IDRegistry.genItemID("lopata_palka_loza");
Item.createItem("lopata_palka_loza", "Лопатка Из Палки И Лозы", {name: "лопата_палка_лоза", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["lopata_palka_loza"], "palka_loza", ToolType.shovel);


IDRegistry.genItemID("motyga_palka_loza");
Item.createItem("motyga_palka_loza", "Мотыга Из Палки И Лозы", {name: "мотыга_палка_лоза", meta: 0}, {stack: 1});
...
Item.createItem("nozh_palka_kozha", "Ножик Из Палки И Кожи", {name: "нож_палка_кожа", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["nozh_palka_kozha"], "palka_kozha", ToolType.sword);


IDRegistry.genItemID("topor_palka_kozha");
Item.createItem("topor_palka_kozha", "Топорик Из Палки И Кожи", {name: "топор_палка_кожа", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["topor_palka_kozha"], "palka_kozha", ToolType.axe);


IDRegistry.genItemID("kirka_palka_kozha");
Item.createItem("kirka_palka_kozha", "Кирка Из Палки И Кожи", {name: "кирка_палка_кожа", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["kirka_palka_kozha"], "palka_kozha", ToolType.pickaxe);


IDRegistry.genItemID("lopata_palka_kozha");
Item.createItem("lopata_palka_kozha", "Лопатка Из Палки И Кожи", {name: "лопата_палка_кожа", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["lopata_palka_kozha"], "palka_kozha", ToolType.shovel);


IDRegistry.genItemID("motyga_palka_kozha");
Item.createItem("motyga_palka_kozha", "Мотыга Из Палки И Кожи", {name: "мотыга_палка_кожа", meta: 0}, {stack: 1});
...
Item.createItem("nozh_kost_volokno", "Ножик Из Кости И Волокна", {name: "нож_кость_волокно", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["nozh_kost_volokno"], "kost_volokno", ToolType.sword);


IDRegistry.genItemID("topor_kost_volokno");
Item.createItem("topor_kost_volokno", "Топорик Из Кости И Волокна", {name: "топор_кость_волокно", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["topor_kost_volokno"], "kost_volokno", ToolType.axe);


IDRegistry.genItemID("kirka_kost_volokno");
Item.createItem("kirka_kost_volokno", "Кирка Из Кости И Волокна", {name: "кирка_кость_волокно", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["kirka_kost_volokno"], "kost_volokno", ToolType.pickaxe);


IDRegistry.genItemID("lopata_kost_volokno");
Item.createItem("lopata_kost_volokno", "Лопатка Из Кости И Волокна", {name: "лопата_кость_волокно", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["lopata_kost_volokno"], "kost_volokno", ToolType.shovel);


IDRegistry.genItemID("motyga_kost_volokno");
Item.createItem("motyga_kost_volokno", "Мотыга Из Кости И Волокна", {name: "мотыга_кость_волокно", meta: 0}, {stack: 1});
...
Item.createItem("nozh_kost_loza", "Ножик Из Кости И Лозы", {name: "нож_кость_лоза", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["nozh_kost_loza"], "kost_loza", ToolType.sword);


IDRegistry.genItemID("topor_kost_loza");
Item.createItem("topor_kost_loza", "Топорик Из Кости И Лозы", {name: "топор_кость_лоза", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["topor_kost_loza"], "kost_loza", ToolType.axe);


IDRegistry.genItemID("kirka_kost_loza");
Item.createItem("kirka_kost_loza", "Кирка Из Кости И Лозы", {name: "кирка_кость_лоза", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["kirka_kost_loza"], "kost_loza", ToolType.pickaxe);


IDRegistry.genItemID("lopata_kost_loza");
Item.createItem("lopata_kost_loza", "Лопатка Из Кости И Лозы", {name: "лопата_кость_лоза", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["lopata_kost_loza"], "kost_loza", ToolType.shovel);


IDRegistry.genItemID("motyga_kost_loza");
Item.createItem("motyga_kost_loza", "Мотыга Из Кости И Лозы", {name: "мотыга_кость_лоза", meta: 0}, {stack: 1});
...
Item.createItem("nozh_kost_kozha", "Ножик Из Кости И Кожи", {name: "нож_кость_кожа", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["nozh_kost_kozha"], "kost_kozha", ToolType.sword);


IDRegistry.genItemID("topor_kost_kozha");
Item.createItem("topor_kost_kozha", "Топорик Из Кости И Кожи", {name: "топор_кость_кожа", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["topor_kost_kozha"], "kost_kozha", ToolType.axe);


IDRegistry.genItemID("kirka_kost_kozha");
Item.createItem("kirka_kost_kozha", "Кирка Из Кости И Кожи", {name: "кирка_кость_кожа", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["kirka_kost_kozha"], "kost_kozha", ToolType.pickaxe);


IDRegistry.genItemID("lopata_kost_kozha");
Item.createItem("lopata_kost_kozha", "Лопатка Из Кости И Кожи", {name: "лопата_кость_кожа", meta: 0}, {stack: 1});
ToolAPI.setTool(ItemID["lopata_kost_kozha"], "kost_kozha", ToolType.shovel);


IDRegistry.genItemID("motyga_kost_kozha");
Item.createItem("motyga_kost_kozha", "Мотыга Из Кости И Кожи", {name: "мотыга_кость_кожа", meta: 0}, {stack: 1});
