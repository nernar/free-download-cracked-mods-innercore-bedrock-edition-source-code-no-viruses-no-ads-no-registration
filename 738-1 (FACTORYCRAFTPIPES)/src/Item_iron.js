...
Block.createBlock("pipeItemIron", [{name: "Iron Transport Pipe", texture: [["pipe_iron", 0]], inCreative: true}]);
IDRegistry.genBlockID("pipeItemIron_a");
Block.createBlock("pipeItemIron_a", [{name: "Iron Pipe", texture: [["pipe_iron", 1]], inCreative: false}]);
Recipes.addShaped({id: BlockID.pipeItemIron, count: 1, data: 0}, ["aba"], ["a", 265, 0, "b", 20, 0]);
...
var5.addEntry(model);
var6.addEntry(model);
var boxes1 = [{side: [1, 0, 0], box: box1, id: BlockID.pipeItemIron_a}, {side: [-1, 0, 0], box: box2, id: BlockID.pipeItemIron_a}, {side: [0, 1, 0], box: box3, id: BlockID.pipeItemIron_a}, {side: [0, -1, 0], box: box4, id: BlockID.pipeItemIron_a}, {side: [0, 0, 1], box: box5, id: BlockID.pipeItemIron_a}, {side: [0, 0, -1], box: box6, id: BlockID.pipeItemIron}];
var boxes2 = [{side: [1, 0, 0], box: box1, id: BlockID.pipeItemIron_a}, {side: [-1, 0, 0], box: box2, id: BlockID.pipeItemIron_a}, {side: [0, 1, 0], box: box3, id: BlockID.pipeItemIron_a}, {side: [0, -1, 0], box: box4, id: BlockID.pipeItemIron_a}, {side: [0, 0, 1], box: box5, id: BlockID.pipeItemIron}, {side: [0, 0, -1], box: box6, id: BlockID.pipeItemIron_a}];
var boxes3 = [{side: [1, 0, 0], box: box1, id: BlockID.pipeItemIron_a}, {side: [-1, 0, 0], box: box2, id: BlockID.pipeItemIron}, {side: [0, 1, 0], box: box3, id: BlockID.pipeItemIron_a}, {side: [0, -1, 0], box: box4, id: BlockID.pipeItemIron_a}, {side: [0, 0, 1], box: box5, id: BlockID.pipeItemIron_a}, {side: [0, 0, -1], box: box6, id: BlockID.pipeItemIron_a}];
var boxes4 = [{side: [1, 0, 0], box: box1, id: BlockID.pipeItemIron}, {side: [-1, 0, 0], box: box2, id: BlockID.pipeItemIron_a}, {side: [0, 1, 0], box: box3, id: BlockID.pipeItemIron_a}, {side: [0, -1, 0], box: box4, id: BlockID.pipeItemIron_a}, {side: [0, 0, 1], box: box5, id: BlockID.pipeItemIron_a}, {side: [0, 0, -1], box: box6, id: BlockID.pipeItemIron_a}];
var boxes5 = [{side: [1, 0, 0], box: box1, id: BlockID.pipeItemIron_a}, {side: [-1, 0, 0], box: box2, id: BlockID.pipeItemIron_a}, {side: [0, 1, 0], box: box3, id: BlockID.pipeItemIron_a}, {side: [0, -1, 0], box: box4, id: BlockID.pipeItemIron}, {side: [0, 0, 1], box: box5, id: BlockID.pipeItemIron_a}, {side: [0, 0, -1], box: box6, id: BlockID.pipeItemIron_a}];
var boxes6 = [{side: [1, 0, 0], box: box1, id: BlockID.pipeItemIron_a}, {side: [-1, 0, 0], box: box2, id: BlockID.pipeItemIron_a}, {side: [0, 1, 0], box: box3, id: BlockID.pipeItemIron}, {side: [0, -1, 0], box: box4, id: BlockID.pipeItemIron_a}, {side: [0, 0, 1], box: box5, id: BlockID.pipeItemIron_a}, {side: [0, 0, -1], box: box6, id: BlockID.pipeItemIron_a}];
for (var i in boxes1) {
    var box = boxes1[i];
    var model = BlockRenderer.createModel();
...
TileEntity.registerPrototype(BlockID.pipeItemIron, {getTransportingDirections: function (item) {
    var a = [];
