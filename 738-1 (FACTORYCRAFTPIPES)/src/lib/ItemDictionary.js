LIBRARY({name: "ItemDictionary", version: 1, shared: true, api: "CoreEngine", dependencies: []});
var ItemDictionary = {dictionary: {}, createCathegory: function (name) {
    this.dictionary[name] = {};
}, setItemCathegory: function (id, name) {
    if (!this.dictionary[name]) {
        this.createCathegory(name);
    }
