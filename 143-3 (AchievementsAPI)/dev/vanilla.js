...
Callback.addCallback("NativeGuiChanged", function (screenName) {
    if (screenName === "world_loading_progress_screen - nether" && !Player.getDimension()) {
        ...
        nether_coords = {x: position.x, y: position.y, z: position.z};
    }
});
...
Recipes.addShaped({id: 274, count: 1, data: 0}, ["xxx", " a ", " a "], ["x", 4, 0, "a", 280, 0], function () {
    AchievementAPI.give("story", "upgrade_tools");
});
Recipes.deleteRecipe({id: 307, count: 1, data: 0});
Recipes.addShaped({id: 307, count: 1, data: 0}, ["x x", "xxx", "xxx"], ["x", 265, 0], function () {
    AchievementAPI.give("story", "obtain_armor");
});
Recipes.deleteRecipe({id: 257, count: 1, data: 0});
Recipes.addShaped({id: 257, count: 1, data: 0}, ["xxx", " a ", " a "], ["x", 265, 0, "a", 280, 0], function () {
    AchievementAPI.give("story", "iron_tools");
});
Recipes.deleteRecipe({id: 311, count: 1, data: 0});
Recipes.addShaped({id: 311, count: 1, data: 0}, ["x x", "xxx", "xxx"], ["x", 264, 0], function () {
