const AchievementPopup = {popupQueue: [], container: new UI.Container(), delay: 0, show: function (obj) {
    this.popupQueue.push(obj);
}, popQueue: function () {
    return this.popupQueue.pop();
}, init: function () {
    this.popupUI = new UI.Window({location: {x: 700, y: 0, width: 300, height: 60}, drawing: [{type: "color", color: Color.rgb(33, 33, 33)}, {type: "frame", x: 0, y: 0, width: 1000, height: 200, bitmap: "frame_achievement", scale: 5}], elements: {"title": {type: "text", text: "", x: 190, y: 30, font: {color: Color.YELLOW, size: 50}}, "description": {type: "text", text: "", x: 190, y: 100, font: {color: Color.WHITE, size: 50}}, "slot": {type: "slot", x: 5, y: 5, size: 190, bitmap: "_default_slot_empty", isTransparentBackground: true, visual: true}}});
