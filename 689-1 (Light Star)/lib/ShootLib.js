...
var TypeFace = FileTools.root+"games/com.mojang/innercore/mc-typeface.ttf";

if(!IS_HORIZON)
    Game.getGameMode = function(){return 0;};

if(IS_HORIZON)
    TypeFace =  __packdir__ + "/innercore/mc-typeface.ttf";
...
var GUI = {
    ...
    createText:function(button){
        ...
        if(a==true && FileTools.isExists(TypeFace))
            text.setTypeface(android.graphics.Typeface.createFromFile(TypeFace));
