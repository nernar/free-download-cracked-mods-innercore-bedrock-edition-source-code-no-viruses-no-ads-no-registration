DynamoHelper.registerDynamo("dynamoSteam", "Steam Dynamo", "dynamo_steam", {defaultValues: {fuelMax: 0, fuelRF: 0, waterRF: 0, energy: 0, rotate: 0, isActive: false}, init: function () {
    ...
    if (World.getThreadTime() % 20 === 0) {
        ContainerHelper.fluidContainerEmpty(["water"], this, {full: "slotWaterContainer", empty: "slotWaterContainerEmpty"});
    }
    if (this.data.isActive) {
        ...
        if (World.getThreadTime() % 32 === 0 && this.canStart()) {
            this.processStart();
...
Callback.addCallback("PostLoaded", function () {
    Recipes.addShaped({id: BlockID.dynamoSteam, count: 1, data: 0}, [" 1 ", "323", "545"], ["1", ItemID.redstoneTransmissionCoil, 0, "2", ItemID.gearCopper, 0, "3", 265, 0, "4", 331, 0, "5", ItemID.ingotCopper, 0]);
});
