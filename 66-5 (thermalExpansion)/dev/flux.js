...
Block.createBlock("fluxductLeadstone", [{name: "Leadstone Fluxduct", texture: [["fluxduct_lead", 0]], inCreative: true}]);
...
Callback.addCallback("PostLoaded", function () {
    Recipes.addShaped({id: BlockID.fluxductLeadstone, count: 6, data: 0}, ["111", "a2a", "111"], ["1", 331, 0, "a", ItemID.ingotLead, 0, "2", 20, 0]);
});
