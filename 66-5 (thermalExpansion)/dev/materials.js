...
Callback.addCallback("PostLoaded", function () {
    PulverizerRecipes.add({input: {id: 265, data: 0}, result: {id: ItemID.dustIron, data: 0, count: 1}});
    PulverizerRecipes.add({input: {id: 266, data: 0}, result: {id: ItemID.dustGold, data: 0, count: 1}});
    addRecipeWithCraftingTool({id: ItemID.plateIron, count: 1, data: 0}, [{id: 265, data: 0}], ItemID.thermalHammer);
    addRecipeWithCraftingTool({id: ItemID.plateGold, count: 1, data: 0}, [{id: 266, data: 0}], ItemID.thermalHammer);
    Recipes.addShaped({id: ItemID.thermalHammer, count: 1, data: 0}, ["222", "212", "a1a"], ["1", 280, 0, "2", 265, 0]);
