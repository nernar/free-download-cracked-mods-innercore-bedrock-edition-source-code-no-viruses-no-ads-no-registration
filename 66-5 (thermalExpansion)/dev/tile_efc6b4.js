MachineRegistry.register(BlockID.redFurnace, {ENERGY_CONSUME: 20, PROGRESS_MAX: 150, defaultValues: {progress: 0}, getGuiScreen: function () {
    ...
    if (this.data.progress) {
        ...
        if (slotSource.id && Recipes.getFurnaceRecipeResult(slotSource.id, "iron")) {
