DynamoHelper.registerDynamo("dynamoMagmatic", "Magmatic Dynamo", "dynamo_magmatic", {defaultValues: {energy: 0, rotate: 0, isActive: false, fuelRF: 0}, init: function () {
...
Callback.addCallback("PostLoaded", function () {
    Recipes.addShaped({id: BlockID.dynamoMagmatic, count: 1, data: 0}, [" 1 ", "323", "545"], ["1", ItemID.redstoneTransmissionCoil, 0, "2", ItemID.gearInvar, 0, "3", 265, 0, "4", 331, 0, "5", ItemID.ingotInvar, 0]);
});
