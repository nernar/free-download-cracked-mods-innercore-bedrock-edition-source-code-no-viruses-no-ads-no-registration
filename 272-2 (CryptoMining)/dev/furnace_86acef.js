...
const regFurnace = function (id, name, speed) {
    ...
    TileEntity.registerPrototype(BlockID[id], {getGuiScreen: function () {
        return new UI.StandartWindow({standart: {header: {text: {text: name}}, inventory: {standart: true}, background: {standart: true}}, drawing: [{type: "bitmap", x: 492, y: 137, bitmap: "burn_0", scale: 3.2}, {type: "bitmap", x: 555, y: 135, bitmap: "prog_0", scale: 3.2}, {type: "bitmap", x: 2000, y: 200, bitmap: "lava_0", scale: 3.2}], elements: {"scaleBurn": {type: "scale", x: 490, y: 135, direction: 1, value: 0, bitmap: "burn_1", scale: 3.2}, "scaleProg": {type: "scale", x: 555, y: 135, value: 0, bitmap: "prog_1", scale: 3.2}, "scaleLava": {type: "scale", x: 2000, y: 200, direction: 1, value: 0, bitmap: "lava_1", scale: 3.2}, "slotUpgrade0": {type: "slot", x: 340, y: 60}, "slotUpgrade1": {type: "slot", x: 340, y: 120}, "slotUpgrade2": {type: "slot", x: 340, y: 180}, "slotSource1": {type: "slot", x: 480, y: 60}, "slotFuel1": {type: "slot", x: 480, y: 200}, "slotResult1": {type: "slot", x: 640, y: 130}, "slotSource2": {type: "slot", x: 2000, y: 60}, "slotFuel2": {type: "slot", x: 2000, y: 200}, "slotResult2": {type: "slot", x: 2000, y: 130}}});
...
const ORE = [14, 15, 16, 56, 129, BlockID.bitcoin, BlockID.ethereum, BlockID.concoin, BlockID.arkcoin, BlockID.wondercoin, BlockID.cosmocash, BlockID.augur, BlockID.lisk, BlockID.firecoin, BlockID.zerocash, BlockID.dashcoin, BlockID.monero, BlockID.ripple, BlockID.windcoin, BlockID.litecoin, BlockID.dogecoin, BlockID.buzcoin, BlockID.peercoin, BlockID.mooncoin, BlockID.marscoin, BlockID.oreCopper, BlockID.oreTin, BlockID.oreLead, BlockID.oreAluminum, BlockID.oreNickel, BlockID.orePlatinum, BlockID.oreIridium, BlockID.oreMithril, BlockID.orecoppere, BlockID.draconiumOre, BlockID.draconiumOreNether, BlockID.draconiumOreEnd];
