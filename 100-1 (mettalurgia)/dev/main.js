...
var olovot = Block.createSpecialType({base: 1, destroytime: 2});
var medt = Block.createSpecialType({base: 1, destroytime: 2.5});
var platinat = Block.createSpecialType({base: 1, destroytime: 3.5});
var voliframt = Block.createSpecialType({base: 1, destroytime: 4});
var uraniumt = Block.createSpecialType({base: 1, destroytime: 5});
var titant = Block.createSpecialType({base: 1, destroytime: 6.5});
var litertt = Block.createSpecialType({base: 1, destroytime: 7.5});
var dlitertt = Block.createSpecialType({base: 1, destroytime: 9});
IDRegistry.genBlockID("olovo");
Block.createBlock("olovo", [{name: "Olovo", texture: [["olovo", 0]], inCreative: true}], olovot);
ToolAPI.registerBlockMaterial(BlockID.olovo, "stone");
IDRegistry.genBlockID("med");
Block.createBlock("med", [{name: "Med", texture: [["med", 0]], inCreative: true}], medt);
ToolAPI.registerBlockMaterial(BlockID.med, "stone");
IDRegistry.genBlockID("platina");
Block.createBlock("platina", [{name: "Platinum ore", texture: [["platina", 0]], inCreative: true}], platinat);
ToolAPI.registerBlockMaterial(BlockID.platina, "stone");
IDRegistry.genBlockID("volifram");
Block.createBlock("volifram", [{name: "Volifram", texture: [["volifram", 0]], inCreative: true}], voliframt);
ToolAPI.registerBlockMaterial(BlockID.volifram, "stone");
IDRegistry.genBlockID("uranium");
Block.createBlock("uranium", [{name: "Uranium", texture: [["uranium", 0]], inCreative: true}], uraniumt);
ToolAPI.registerBlockMaterial(BlockID.uranium, "stone");
IDRegistry.genBlockID("titan");
Block.createBlock("titan", [{name: "Titan", texture: [["titan", 0]], inCreative: true}], titant);
ToolAPI.registerBlockMaterial(BlockID.titan, "stone");
IDRegistry.genBlockID("lit");
Block.createBlock("lit", [{name: "Litert", texture: [["litert", 0]], inCreative: true}], litertt);
ToolAPI.registerBlockMaterial(BlockID.lit, "stone");
IDRegistry.genBlockID("dl");
Block.createBlock("dl", [{name: "Dark litert", texture: [["darklitert", 0]], inCreative: true}], dlitertt);
ToolAPI.registerBlockMaterial(BlockID.dl, "stone");
IDRegistry.genBlockID("ds");
Block.createBlock("ds", [{name: "Dark stone", texture: [["darks", 0]], inCreative: true}]);
Block.setBlockShape(BlockID.ds, {x: 0.5, y: 0, z: 0.4}, {x: 0.6, y: 0.8, z: 0.5});
IDRegistry.genBlockID("sch");
Block.createBlock("sch", [{name: "Sch", texture: [["bsch", 0], ["sch", 0], ["bsch", 0], ["dsb", 0], ["bsch", 0], ["bsch", 0]], inCreative: true}]);
...
Block.createBlock("dsb", [{name: "Dsb", texture: [["dsb", 0]], inCreative: true}]);
...
Recipes.addShaped({id: ItemID.olovosword, count: 1, data: 0}, [" a", " a", " b"], ["a", ItemID.olovo, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.medsword, count: 1, data: 0}, [" a", " a", " b"], ["a", ItemID.med, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.plasword, count: 1, data: 0}, [" a", " a", " b"], ["a", ItemID.plat, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.volisword, count: 1, data: 0}, [" a", " a", " b"], ["a", ItemID.volifram, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.ursword, count: 1, data: 0}, [" a", " a", " b"], ["a", ItemID.uran, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.titsword, count: 1, data: 0}, [" a", " a", " b"], ["a", ItemID.titan, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.litsword, count: 1, data: 0}, [" a", " a", " b"], ["a", ItemID.lit, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.dlsword, count: 1, data: 0}, [" a", " a", " b"], ["a", ItemID.dl, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.olovokirka, count: 1, data: 0}, ["aaa", " b", " b"], ["a", ItemID.olovo, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.mk, count: 1, data: 0}, ["aaa", " b", " b"], ["a", ItemID.med, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.pk, count: 1, data: 0}, ["aaa", " b", " b"], ["a", ItemID.plat, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.vk, count: 1, data: 0}, ["aaa", " b", " b"], ["a", ItemID.volifram, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.uk, count: 1, data: 0}, ["aaa", " b", " b"], ["a", ItemID.uran, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.tk, count: 1, data: 0}, ["aaa", " b", " b"], ["a", ItemID.titan, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.lk, count: 1, data: 0}, ["aaa", " b", " b"], ["a", ItemID.lit, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.dlk, count: 1, data: 0}, ["aaa", " b", " b"], ["a", ItemID.dl, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.ot, count: 1, data: 0}, ["aa ", "ab ", " b "], ["a", ItemID.olovo, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.mt, count: 1, data: 0}, ["aa ", "ab ", " b "], ["a", ItemID.med, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.pt, count: 1, data: 0}, ["aa ", "ab ", " b "], ["a", ItemID.plat, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.ut, count: 1, data: 0}, ["aa ", "ab ", " b "], ["a", ItemID.uran, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.tt, count: 1, data: 0}, ["aa ", "ab ", " b "], ["a", ItemID.titan, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.vt, count: 1, data: 0}, ["aa ", "ab ", " b "], ["a", ItemID.volifram, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.lt, count: 1, data: 0}, ["aa ", "ab ", " b "], ["a", ItemID.lit, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.dlt, count: 1, data: 0}, ["aa ", "ab ", " b "], ["a", ItemID.dl, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.ol, count: 1, data: 0}, [" a", " b", " b"], ["a", ItemID.olovo, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.ml, count: 1, data: 0}, [" a", " b", " b"], ["a", ItemID.med, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.pl, count: 1, data: 0}, [" a", " b", " b"], ["a", ItemID.plat, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.vl, count: 1, data: 0}, [" a", " b", " b"], ["a", ItemID.volifram, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.ul, count: 1, data: 0}, [" a", " b", " b"], ["a", ItemID.uran, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.tl, count: 1, data: 0}, [" a", " b", " b"], ["a", ItemID.titan, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.ll, count: 1, data: 0}, [" a", " b", " b"], ["a", ItemID.lit, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.dll, count: 1, data: 0}, [" a", " b", " b"], ["a", ItemID.dl, 0, "b", 280, 0]);
Recipes.addShaped({id: ItemID.darkstone, count: 1, data: 0}, [" a ", "aba", " a "], ["a", ItemID.ods, 0, "b", 388, 0]);
Recipes.addShaped({id: BlockID.dsb, count: 1, data: 0}, [" a ", "aba", " a "], ["a", ItemID.darkstone, 0, "b", 264, 0]);
...
Recipes.addShaped({id: ItemID.oh, count: 1, data: 0}, ["aaa", "a a", "   "], ["a", ItemID.olovo, 0]);
Recipes.addShaped({id: ItemID.mh, count: 1, data: 0}, ["aaa", "a a", "   "], ["a", ItemID.med, 0]);
Recipes.addShaped({id: ItemID.ph, count: 1, data: 0}, ["aaa", "a a", "   "], ["a", ItemID.plat, 0]);
Recipes.addShaped({id: ItemID.vh, count: 1, data: 0}, ["aaa", "a a", "   "], ["a", ItemID.volifram, 0]);
Recipes.addShaped({id: ItemID.uh, count: 1, data: 0}, ["aaa", "a a", "   "], ["a", ItemID.uran, 0]);
Recipes.addShaped({id: ItemID.th, count: 1, data: 0}, ["aaa", "a a", "   "], ["a", ItemID.titan, 0]);
Recipes.addShaped({id: ItemID.lh, count: 1, data: 0}, ["aaa", "a a", "   "], ["a", ItemID.lit, 0]);
Recipes.addShaped({id: ItemID.dlh, count: 1, data: 0}, ["aaa", "a a", "   "], ["a", ItemID.dl, 0]);
Recipes.addShaped({id: ItemID.och, count: 1, data: 0}, ["a a", "aaa", "aaa"], ["a", ItemID.olovo, 0]);
Recipes.addShaped({id: ItemID.mch, count: 1, data: 0}, ["a a", "aaa", "aaa"], ["a", ItemID.med, 0]);
Recipes.addShaped({id: ItemID.pch, count: 1, data: 0}, ["a a", "aaa", "aaa"], ["a", ItemID.plat, 0]);
Recipes.addShaped({id: ItemID.vch, count: 1, data: 0}, ["a a", "aaa", "aaa"], ["a", ItemID.volifram, 0]);
Recipes.addShaped({id: ItemID.uch, count: 1, data: 0}, ["a a", "aaa", "aaa"], ["a", ItemID.uran, 0]);
Recipes.addShaped({id: ItemID.tch, count: 1, data: 0}, ["a a", "aaa", "aaa"], ["a", ItemID.titan, 0]);
Recipes.addShaped({id: ItemID.lch, count: 1, data: 0}, ["a a", "aaa", "aaa"], ["a", ItemID.lit, 0]);
Recipes.addShaped({id: ItemID.dlch, count: 1, data: 0}, ["a a", "aaa", "aaa"], ["a", ItemID.dl, 0]);
Recipes.addShaped({id: ItemID.ole, count: 1, data: 0}, ["aaa", "a a", "a a"], ["a", ItemID.olovo, 0]);
Recipes.addShaped({id: ItemID.mle, count: 1, data: 0}, ["aaa", "a a", "a a"], ["a", ItemID.med, 0]);
Recipes.addShaped({id: ItemID.ple, count: 1, data: 0}, ["aaa", "a a", "a a"], ["a", ItemID.plat, 0]);
Recipes.addShaped({id: ItemID.vle, count: 1, data: 0}, ["aaa", "a a", "a a"], ["a", ItemID.volifram, 0]);
Recipes.addShaped({id: ItemID.ule, count: 1, data: 0}, ["aaa", "a a", "a a"], ["a", ItemID.uran, 0]);
Recipes.addShaped({id: ItemID.tle, count: 1, data: 0}, ["aaa", "a a", "a a"], ["a", ItemID.titan, 0]);
Recipes.addShaped({id: ItemID.lle, count: 1, data: 0}, ["aaa", "a a", "a a"], ["a", ItemID.lit, 0]);
Recipes.addShaped({id: ItemID.dlle, count: 1, data: 0}, ["aaa", "a a", "a a"], ["a", ItemID.dl, 0]);
Recipes.addShaped({id: ItemID.ob, count: 1, data: 0}, ["   ", "a a", "a a"], ["a", ItemID.olovo, 0]);
Recipes.addShaped({id: ItemID.mb, count: 1, data: 0}, ["   ", "a a", "a a"], ["a", ItemID.med, 0]);
Recipes.addShaped({id: ItemID.pb, count: 1, data: 0}, ["   ", "a a", "a a"], ["a", ItemID.plat, 0]);
Recipes.addShaped({id: ItemID.vb, count: 1, data: 0}, ["   ", "a a", "a a"], ["a", ItemID.volifram, 0]);
Recipes.addShaped({id: ItemID.ub, count: 1, data: 0}, ["   ", "a a", "a a"], ["a", ItemID.uran, 0]);
Recipes.addShaped({id: ItemID.tb, count: 1, data: 0}, ["   ", "a a", "a a"], ["a", ItemID.titan, 0]);
Recipes.addShaped({id: ItemID.lb, count: 1, data: 0}, ["   ", "a a", "a a"], ["a", ItemID.lit, 0]);
Recipes.addShaped({id: ItemID.dlb, count: 1, data: 0}, ["   ", "a a", "a a"], ["a", ItemID.dl, 0]);
Recipes.addShaped({id: BlockID.sch, count: 1, data: 0}, ["    ", "w w", "aba"], ["a", ItemID.darkstone, 0, "b", BlockID.dsb, 0, "w", 264, 0]);
...
TileEntity.registerPrototype(BlockID.mci, {defaultValues: {}, getGuiScreen: function () {
    return mciGUI;
}, tick: function () {
...
var mciGUI = new UI.StandartWindow({standart: {header: {text: {text: "metall"}}, inventory: {standart: true}, background: {standart: true}}, drawing: [{type: "bitmap", x: 620, y: 150, bitmap: "testbar", scale: 4}], elements: {"slotInput": {type: "slot", bitmap: "testslot2", x: 500, y: 150, size: 100}, "slotInput1": {type: "slot", bitmap: "testslot2", x: 700, y: 150, size: 100}, "slotOutput": {type: "slot", x: 600, y: 350, size: 100}, "slottoplivo": {type: "slot", bitmap: "testslot3", x: 600, y: 50, size: 100}}});
...
TileEntity.registerPrototype(BlockID.smc, {defaultValues: {}, getGuiScreen: function () {
    return smcGUI;
}, tick: function () {
    var slo = this.container.getSlot("slotInput");
    var slt = this.container.getSlot("slotInput1");
...
var smcGUI = new UI.StandartWindow({standart: {header: {text: {text: "smachine"}}, inventory: {standart: true}, background: {standart: true}}, drawing: [{type: "bitmap", x: 620, y: 150, bitmap: "testbar", scale: 4}], elements: {"slotInput": {type: "slot", x: 500, y: 150, size: 100}, "slotInput1": {type: "slot", bitmap: "testslot", x: 700, y: 150, size: 100}, "slotOutput": {type: "slot", x: 600, y: 350, size: 100}}});
