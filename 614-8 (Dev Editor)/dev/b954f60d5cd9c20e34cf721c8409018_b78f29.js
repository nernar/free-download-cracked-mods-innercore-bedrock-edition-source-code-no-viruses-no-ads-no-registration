            ...
            tryout(function () {
                ...
                if (key.exists()) {
                    ...
                    if (e.message.startsWith("java.net.UnknownHostException")) {
                        ...
                        showValidateInformation(checkValidate.NO_CONNECTION);
                    }
                }
            });
        });
    ...
    type != checkValidate.LIQUIDATE ? handle(function () {
        tryoutSafety(function () {
            ...
            group.addItem("menuProjectLeave", translate("Ignore"), function (item) {
                ...
                __config__.save(), control.dismiss();
            });
            ...
            if (Math.random() > 0.99 && type == checkValidate.NO_CONNECTION) {
                control.addMessage("menuNetworkSupport", translate("Congratulations!") + "\n" + translate("You're finded rare message, it's fully launching modification without testing abilities!"), function () {
                    ProjectEditor.menu(), showHint.unstackLaunch(), showHint(translate("Thanks for attentiveness!"));
                });
            }
            control.show();
        });
