...
const FocusablePopup = function () {
    let set = new ActorSet(), fadeIn = new FadeActor(), fadeOut = new FadeActor();
...
FocusablePopup.prototype.reset = function () {
    ...
    params = new android.widget.LinearLayout.LayoutParams(Interface.Display.MATCH, Interface.Display.MATCH);
    params.weight = 0.1;
