var text = {set: function () {
    ...
    if (e.size != undefined) {
        var size = ", size: " + e.size;
    } else {
        var size = "";
    }
    if (e.bitmap != undefined) {
        var bitmap = ", bitmap: \"" + e.bitmap + "\"";
    } else {
        var bitmap = "";
    }
    if (e.bitmap2 != undefined) {
        var bitmap2 = ", bitmap2: \"" + e.bitmap2 + "\"";
    } else {
        var bitmap2 = "";
    }
    if (e.text != undefined) {
    ...
    if (e.direction != undefined) {
        var direction = ", direction: " + e.direction;
    } else {
        var direction = "";
    }
