...
TutorialSequence.prototype.touchCorrectly = function () {
    ...
    if (random(0, 1) == 0) {
        ...
        this.hint.addMessage(translate("Well done!"));
    }
    this.hint.show();
};
TutorialSequence.prototype.tounchIncorrecrly = function () {
    ...
    if (index < 0) {
        this.hint.addMessage(translate("Nope"));
    } else {
        this.hint.flashHint(index, Interface.Color.YELLOW);
    }
};
...
TutorialSequence.Welcome = new TutorialSequence({count: 2, update: function (progress, index) {
    if (index == 1) {
...
TutorialSequence.ButtonInteraction = new TutorialSequence({count: 5, update: function (progress, index) {
    let sequence = this;
    if (index == 1) {
        ...
        if (index == 2) {
            ...
            if (!this.isOneRequired()) {
                ...
                this.hint.addMessage(translate("You must click it to open control menu."));
            }
            this.hint.show();
        } else {
            if (index == 3) {
...
TutorialSequence.ControlMeeting = new TutorialSequence({count: 7, update: function (progress, index) {
    let sequence = this;
    if (index == 1) {
        ...
        if (isAnyCustomSupportableLoaded()) {
            ...
            if (UIEditor) {
                category.addItem(UIEditor.icon, translate("UIEditor"));
            }
            if (WorldEdit) {
                category.addItem(WorldEdit.icon, translate("WorldEdit"));
            }
            if (DumpCreator) {
                category.addItem(DumpCreator.icon, translate("Dumper"));
            }
            if (RunJSingame) {
                category.addItem(RunJSingame.icon, translate("Run JS"));
            }
            if (InstantRunner) {
                category.addItem(InstantRunner.icon, translate("IRunner"));
            }
        }
        control.show();
        ...
        if (index == 2) {
            ...
            if (!this.isOneRequired()) {
                ...
                this.hint.addMessage(translate("And editor may be added by your wish."));
            }
            this.hint.show();
        } else {
            if (index == 3) {
...
TutorialSequence.SidebarInteraction = new TutorialSequence({count: 7, update: function (progress, index) {
    let sequence = this;
    if (index == 1) {
...
TutorialSequence.PopupInteraction = new TutorialSequence({getNextSequence: function () {
    return TutorialSequence.ProjectMeeting;
}});
TutorialSequence.ProjectMeeting = new TutorialSequence({getNextSequence: function () {
    return TutorialSequence.ControlInteraction;
}});
TutorialSequence.ControlInteraction = new TutorialSequence({getNextSequence: function () {
    return TutorialSequence.ExplorerInteraction;
}});
TutorialSequence.ExplorerInteraction = new TutorialSequence({getNextSequence: function () {
    return TutorialSequence.Complete;
}});
TutorialSequence.Complete = new TutorialSequence({count: 2, update: function (progress, index) {
    if (index == 1) {
