...
SidebarFragment.prototype.resetContainer = function () {
    ...
    if (!menuDividers) {
        scrollTabs.setBackgroundDrawable(ImageFactory.getDrawable("popup"));
    }
...
SidebarFragment.Group.prototype.resetContainer = function () {
    ...
    let params = new android.widget.LinearLayout.LayoutParams(Interface.Display.WRAP, Interface.Display.MATCH);
    if (menuDividers) {
        params.topMargin = Interface.getY(2);
    }
    params.weight = 1;
