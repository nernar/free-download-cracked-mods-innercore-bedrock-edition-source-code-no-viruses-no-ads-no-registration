let EffectAPI = {effect: {}, entity: {}, register: function (obj) {
...
EffectAPI.register({id: "dead", tick: function (ent, time, level) {
}});
EffectAPI.register({id: "magic", tick: function (ent, time, level) {
}});
EffectAPI.register({id: "noy_magic", tick: function (ent, time, level) {
}});
EffectAPI.register({id: "noy_magic_immunity", tick: function (ent, time, level) {
}});
EffectAPI.register({id: "aspects", tick(ent, time, level) {
...
EffectAPI.register({id: "fly", tick: function (ent, time, level) {
