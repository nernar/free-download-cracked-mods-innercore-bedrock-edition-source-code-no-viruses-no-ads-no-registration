...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 5, 132);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_coal, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 5, 68);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_iron, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 5, 70);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_gold, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 14, 34);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_lapis, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 5, 16);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_redstone, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 5, 33);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_emerald, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 5, 16);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_diamond, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateNetherChunk", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 15, 126);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_quartz, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 10, 70);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_copper, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 1, 50);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_tin, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 10, 64);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_iridium, 0, 3);
    }
}
)
...
Callback.addCallback("GenerateChunkUnderground", function (chunkX, chunkZ) {
    for(var i=0;i<5;i++){
        var coords = GenerationUtils.randomCoords(chunkX, chunkZ, 1, 80);
            GenerationUtils.generateOre(coords.x, coords.y, coords.z, BlockID.super_uranium, 0, 3);
    }
}
)
