function Widget(params) {
                ...
                if (this.type == "layout" || this.type == "image" || this.type == "view") {
                    ...
                    if (Array.isArray(param)) {
                        ...
                        if (typeof param != "object") {
                            ...
                            this.setSizes(param.width || param.x, param.height || param.y);
                        }
                    }
                }
                break;
              ...
              case "text":
                if (Array.isArray(param)) {
                    ...
                    if (typeof param != "object") {
                        ...
                        this.setText(param.text, param.format);
                    }
                }
                break;
              case "size":
              ...
              case "padding":
                if (Array.isArray(param)) {
                    if (param.length < 3) {
                        ...
                        this.setPadding(param[0], param[1], param[2], param[3]);
                    }
                } else {
                    if (typeof param != "object") {
                        this.setPadding(param, param, param, param);
                    } else {
                        if (param.horizontal || param.vertical) {
                            this.setPaddingRelative(param.horizontal, param.vertical);
                        } else {
                            this.setPadding(param.left, param.top, param.right, param.bottom);
                        }
                    }
                }
                break;
    ...
    this.setOrientation = function (orientate) {
        if (typeof orientate == "number") {
            this.view.setOrientation(orientate);
        } else {
    ...
    this.setText = function (text, format) {
        if (!format) {
            this.view.setText(translate(text));
        } else {
    ...
    this.setHtmlText = function (text, format) {
        if (!format) {
            this.view.setText(android.text.Html.fromHtml(translate(text)));
        } else {
        ...
        if (typeof color == "number") {
            ...
            if (typeof color == "string") {
                if (color.startsWith("#")) {
                    ...
                    this.view.setTextColor(Ui.Color[color.toUpperCase()]);
                }
            }
        }
    };
    this.setFont = function (font) {
        if (typeof font == "string") {
            this.view.setTypeface(AssetFactory.createFont(font));
        } else {
            font ? this.view.setTypeface(font) : this.view.setTypeface(AssetFactory.createFont());
        }
    };
    this.setResource = function (image) {
        if (typeof image == "string") {
            this.view.setImageBitmap(ImageFactory.getBitmap(image));
        } else {
    ...
    this.setScaleType = function (scale) {
        if (typeof scale == "object") {
            ...
            this.view.setScaleType(Ui.Scale[scale.toUpperCase()]);
        }
    };
        ...
        if (typeof background == "number") {
            ...
            if (typeof background == "string") {
                if (background.startsWith("#")) {
                    ...
                    if (Ui.Color[background.toUpperCase()] + "" != "undefined") {
    ...
    this.setVisibility = function (visibility) {
        if (typeof visibility == "number") {
            ...
            this.view.setVisibility(Ui.Visibility[visibility.toUpperCase()]);
        }
    };
