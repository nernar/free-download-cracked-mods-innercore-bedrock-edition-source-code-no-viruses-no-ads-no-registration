LIBRARY({name: "SoundLib", version: 1, shared: false, api: "CoreEngine"});
var SoundManager;
(function (SoundManager) {
    ...
    function playSoundAtBlock(tile, soundName, volume, radius) {
        ...
        return playSoundAt(tile.x + 0.5, tile.y + 0.5, tile.z + 0.5, soundName, volume, 1, radius);
    }
...
var AudioSource = (function () {
    function AudioSource(sourceType, source, soundName, volume, radius) {
        ...
        if (sourceType = SourceType.TILEENTITY) {
            this.position = {x: source.x + 0.5, y: source.y + 0.5, z: source.z + 0.5};
