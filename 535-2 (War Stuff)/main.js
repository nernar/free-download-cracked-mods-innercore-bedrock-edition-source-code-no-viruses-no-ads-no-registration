...
Recipes.addShaped({id: ItemID.desert_camo_helmet, count: 1, data: 0}, [
	"xxx",
	"x x"
], ['x', ItemID.desert_camo_cloth, 0]);

Recipes.addShaped({id: ItemID.desert_camo_body, count: 1, data: 0}, [
	"x x",
	"xxx",
	"xxx"
], ['x', ItemID.desert_camo_cloth, 0]);

Recipes.addShaped({id: ItemID.desert_camo_legs, count: 1, data: 0}, [
	"xxx",
	"x x",
	"x x"
], ['x', ItemID.desert_camo_cloth, 0]);

Recipes.addShaped({id: ItemID.desert_camo_boots, count: 1, data: 0}, [
	"x x",
	"x x"
], ['x', ItemID.desert_camo_cloth, 0]);
...
Recipes.addShaped({id: ItemID.forest_camo_helmet, count: 1, data: 0}, [
	"xxx",
	"x x"
], ['x', ItemID.forest_camo_cloth, 0]);

Recipes.addShaped({id: ItemID.forest_camo_body, count: 1, data: 0}, [
	"x x",
	"xxx",
	"xxx"
], ['x', ItemID.forest_camo_cloth, 0]);

Recipes.addShaped({id: ItemID.forest_camo_legs, count: 1, data: 0}, [
	"xxx",
	"x x",
	"x x"
], ['x', ItemID.forest_camo_cloth, 0]);

Recipes.addShaped({id: ItemID.forest_camo_boots, count: 1, data: 0}, [
	"x x",
	"x x"
], ['x', ItemID.forest_camo_cloth, 0]);
