...
Recipes.addShaped({id: ItemID.energy_compensator, count: 1, data: 0}, [" b ", "pap", "wcw"], ["a", ItemID.autogenerator, 0, "p", ItemID.casingTin, 0, "b", ItemID.storageBattery, 0, "c", ItemID.circuitBasic, 0, "w", ItemID.cableGold2, 0]);
