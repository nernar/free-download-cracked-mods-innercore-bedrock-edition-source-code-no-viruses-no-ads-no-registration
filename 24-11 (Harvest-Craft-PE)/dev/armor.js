...
Callback.addCallback("PostLoaded", function () {
    ...
    Recipes.addShaped({id: ItemID.hardedHelm, count: 1, data: 0}, ["xxx", "x x"], ["x", ItemID.hardedLeather, 0]);
    Recipes.addShaped({id: ItemID.hardedChestplate, count: 1, data: 0}, ["x x", "xxx", "xxx"], ["x", ItemID.hardedLeather, 0]);
    Recipes.addShaped({id: ItemID.hardedLegging, count: 1, data: 0}, ["xxx", "x x", "x x"], ["x", ItemID.hardedLeather, 0]);
    Recipes.addShaped({id: ItemID.hardedFoots, count: 1, data: 0}, ["x x", "x x"], ["x", ItemID.hardedLeather, 0]);
});
