LIBRARY({name: "Harvest_Core", version: 8, shared: true, api: "CoreEngine"});
var Flags = {allFlags: {}, addFlag: function (name) {
...
var Harvest = {toolList: {}, dropWithoutDirt: {}, dropWithoutLeaves: {}, grassDropsArray: [], getStringID: function (intID, isItem) {
...
var CropRegistry = {cropClasses: {}, registerWithID: function (blockID, name, texture, BLOCK_TYPE) {
    if (typeof texture == "string") {
        ...
        Block.createBlock(blockID, [{name: name, texture: [["empty", 0], ["empty", 0], [texture, 0]], inCreative: false}, {name: name, texture: [["empty", 0], ["empty", 0], [texture, 1]], inCreative: false}, {name: name, texture: [["empty", 0], ["empty", 0], [texture, 2]], inCreative: false}], BLOCK_TYPE);
    } else {
        IDRegistry.genBlockID(blockID);
