...
Block.createBlock("liquid_tank_sc",[{name: "Liquid tank", texture: [["tank", 0]], inCreative: false} ]);
...
model.addBox(3/16, 0, 3/16, 1, 1,1/16,"tank", 0);
model.addBox(3/16, 0, 3/14, 1/16, 1,1,"tank", 0);
//model.addBox(14/16, 0, 1/16, 0, 1,16/16,"tank", 0);
//model.addBox(11/16, 0, 1/16, 1, 1,11/16,"tank", 0);
...
BlockRenderer.setStaticICRender(BlockID.liquid_tank_sc, -1, render);
