...
var GUI = {ctx: UI.getContext(), Native: {classLoader: UI.getContext().getClass().getClassLoader(), t_int: java.lang.Integer.TYPE, t_str: java.lang.String}, Gravity: {TOP: 48, LEFT: 3, BOTTOM: 80, RIGHT: 5, CENTER: 17}, Size: {MATCH_PARENT: -1, WRAP_CONTENT: -2, getHeightWindow: function () {
    return GUI.Size.HEIGHT - GUI.getUnitsInPixels(10);
}, getWidthWindow: function () {
    return GUI.Size.WIDTH - GUI.getUnitsInPixels(10);
}}, Direction: {TOP: 4, BOTTOM: 1, RIGHT: 2, LEFT: 3}, Tab: {TOP: 1, BOTTOM: 2, LEFT: 3, RIGHT: 4}, DefaultTextures: {header: {name: "GUILib.png", assets: false, bitmap: {x: 0, y: 0, width: 6, height: 6, ninePatch: [{x: 2, y: 2}, {x: 4, y: 4}], scale: 6}}, panel: {name: "GUILib.png", assets: false, bitmap: {x: 6, y: 0, width: 6, height: 6, ninePatch: [{x: 2, y: 2}, {x: 3, y: 3}], scale: 6}}, button: {normal: {name: "GUILib.png", assets: false, bitmap: {x: 6, y: 6, width: 6, height: 6, ninePatch: [{x: 1, y: 1}, {x: 5, y: 5}], scale: 6}}, pressed: {name: "GUILib.png", assets: false, bitmap: {x: 0, y: 6, width: 6, height: 6, ninePatch: [{x: 1, y: 1}, {x: 5, y: 5}], scale: 6}}}, exitButton: {normal: {name: "GUILib.png", assets: false, bitmap: {x: 12, y: 0, width: 18, height: 18, scale: 4.5}}, pressed: {name: "GUILib.png", assets: false, bitmap: {x: 30, y: 0, width: 18, height: 18, scale: 4.5}}}, exitButtonDialog: {normal: {name: "GUILib.png", bitmap: {x: 0, y: 18, width: 15, height: 15, scale: 4.5}}, pressed: {name: "GUILib.png", bitmap: {x: 15, y: 18, width: 15, height: 15, scale: 4.5}}}, scales: {vertical: {empty: {name: "GUILib.png", assets: false, bitmap: {x: 57, y: 20, width: 13, height: 13, scale: 6}}, full: {name: "GUILib.png", assets: false, bitmap: {x: 70, y: 20, width: 13, height: 13, scale: 6}}}, horizontal: {empty: {name: "GUILib.png", assets: false, bitmap: {x: 84, y: 18, width: 22, height: 15, scale: 6}}, full: {name: "GUILib.png", assets: false, bitmap: {x: 106, y: 18, width: 22, height: 15, scale: 6}}}}, ok: {name: "GUILib.png", bitmap: {x: 30, y: 18, width: 15, height: 12, scale: 4.5}}, cancel: {name: "GUILib.png", bitmap: {x: 45, y: 18, width: 12, height: 12, scale: 4.5}}, tabs: {top: {pressed: {name: "GUILib.png", assets: false, bitmap: {x: 84, y: 6, width: 6, height: 6, ninePatch: [{x: 2, y: 2}, {x: 4, y: 4}], scale: 6}}, normal: {name: "GUILib.png", assets: false, bitmap: {x: 90, y: 6, width: 6, height: 6, ninePatch: [{x: 2, y: 2}, {x: 4, y: 4}], scale: 6}}}, bottom: {pressed: {name: "GUILib.png", assets: false, bitmap: {x: 108, y: 6, width: 6, height: 6, ninePatch: [{x: 2, y: 3}, {x: 4, y: 4}], scale: 6}}, normal: {name: "GUILib.png", assets: false, bitmap: {x: 114, y: 6, width: 6, height: 6, ninePatch: [{x: 2, y: 3}, {x: 4, y: 4}], scale: 6}}}}, slot: {name: "GUILib.png", bitmap: {x: 48, y: 0, width: 16, height: 16, scale: 4}}, frame_slot: {name: "GUILib.png", bitmap: {x: 64, y: 0, width: 20, height: 20, scale: 4}}}, SIZE_SLOT: 16, MARGIN_SLOT: 2, clearExtra: new ItemExtraData(), run: function (f) {
    ...
    if (settings.bitmap && settings.bitmap.ninePatch) {
        if (!(settings.bitmap.ninePatch instanceof Array)) {
            throw new GUI.DrawableException(settings, "settings.bitmap.ninePatch must be an array");
        }
        if (!settings.bitmap.ninePatch[0].x) {
            throw new GUI.DrawableException(settings, "settings.bitmap.ninePatch[0].x is not defined");
        }
        if (!settings.bitmap.ninePatch[0].y) {
            throw new GUI.DrawableException(settings, "settings.bitmap.ninePatch[0].y is not defined");
        }
        if (!settings.bitmap.ninePatch[1].x) {
            throw new GUI.DrawableException(settings, "settings.bitmap.ninePatch[1].x is not defined");
        }
        if (!settings.bitmap.ninePatch[1].y) {
            throw new GUI.DrawableException(settings, "settings.bitmap.ninePatch[1].y is not defined");
        }
        drawable = GUI.createNinePatchFromRaw(drawable, settings.bitmap.ninePatch[0].x * settings.bitmap.scale, settings.bitmap.ninePatch[0].y * settings.bitmap.scale, settings.bitmap.ninePatch[1].x * settings.bitmap.scale, settings.bitmap.ninePatch[1].y * settings.bitmap.scale);
    } else {
    ...
    this.onCreate = function (p) {
        ...
        this.view.setPadding((settings.texture.panel.bitmap.ninePatch) ? (settings.texture.panel.bitmap.ninePatch[0].x * settings.texture.panel.bitmap.scale) : GUI.getUnitsInPixels(5), (settings.texture.panel.bitmap.ninePatch) ? (settings.texture.panel.bitmap.ninePatch[0].y * settings.texture.panel.bitmap.scale) : GUI.getUnitsInPixels(5), (settings.texture.panel.bitmap.ninePatch) ? ((settings.texture.panel.bitmap.width - settings.texture.panel.bitmap.ninePatch[1].x) * settings.texture.panel.bitmap.scale) : GUI.getUnitsInPixels(5), (settings.texture.panel.bitmap.ninePatch) ? ((settings.texture.panel.bitmap.height - settings.texture.panel.bitmap.ninePatch[1].y) * settings.texture.panel.bitmap.scale) : GUI.getUnitsInPixels(5));
    ...
    this.onCreate = function () {
        ...
        if (settings.inventory) {
            ...
            params = new android.widget.RelativeLayout.LayoutParams(GUI.SIZE_SLOT * 4 * (settings.inventory.size || 4), this.getWindow().getHeight() - GUI.getUnitsInPixels(40));
    ...
    this.onCreate = function () {
        ...
        var params = new RelativeLayout.LayoutParams(GUI.Size.MATCH_PARENT, GUI.getUnitsInPixels(100));
        ...
        params = new RelativeLayout.LayoutParams(GUI.getUnitsInPixels(100), GUI.getUnitsInPixels(100));
        params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        ...
        exitButton.create();
        exitButton.window = this;
        exitButton.setOnClick(function (container) {
            container.close();
        });
