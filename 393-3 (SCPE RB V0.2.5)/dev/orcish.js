...
ToolAPI.addToolMaterial("orcishGreatsword", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ShootLib.addGun({id: "orcishBow", name: "Orcish bow", ammo: "orcishArrow", accuracy: 1, recoil: 3, rate: 1, texture: {name: "orcishBow", meta: 0}, shotType: ShotType.NORMAL, buttonType: ButtonType.TOUCH, bullet: {speed: 10, count: 1, entity: Native.EntityType.ARROW, damage: 5}, fov: {level: 5}, sounds: {shot: "BowShoot.ogg", empty: "BowGun.ogg", reload: "reload/BowReload.ogg"}});
ShootLib.addAmmo({id: "orcishArrow", name: "Orcish arrow", texture: {name: "orcishArrow", meta: 0}});
