...
ToolAPI.addToolMaterial("dwarvenBattleaxe", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ToolAPI.addToolMaterial("dwarvenWarhammer", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ToolAPI.addToolMaterial("dwarvenGreatsword", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ShootLib.addGun({id: "dwarvenBow", name: "Dwarven bow", ammo: "dwarvenArrow", accuracy: 1, recoil: 3, rate: 1, texture: {name: "dwarvenBow", meta: 0}, shotType: ShotType.NORMAL, buttonType: ButtonType.TOUCH, bullet: {speed: 10, count: 1, entity: Native.EntityType.ARROW, damage: 5}, fov: {level: 5}, sounds: {shot: "BowShoot.ogg", empty: "BowGun.ogg", reload: "reload/BowReload.ogg"}});
ShootLib.addAmmo({id: "dwarvenArrow", name: "Dwarven arrow", texture: {name: "dwarvenArrow", meta: 0}});
