...
ToolAPI.addToolMaterial("daedricBattleaxe", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ToolAPI.addToolMaterial("daedricWarhammer", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ToolAPI.addToolMaterial("daedricGreatsword", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ShootLib.addGun({id: "daedricBow", name: "Baedric bow", ammo: "daedricArrow", accuracy: 1, recoil: 3, rate: 1, texture: {name: "daedricBow_standby", meta: 0}, shotType: ShotType.NORMAL, buttonType: ButtonType.TOUCH, bullet: {speed: 10, count: 1, entity: Native.EntityType.ARROW, damage: 5}, fov: {level: 5}, sounds: {shot: "BowShoot.ogg", empty: "BowGun.ogg", reload: "reload/BowReload.ogg"}});
ShootLib.addAmmo({id: "daedricArrow", name: "Daedric arrow", texture: {name: "daedricArrow", meta: 0}});
