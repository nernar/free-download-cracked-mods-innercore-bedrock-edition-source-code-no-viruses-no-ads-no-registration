...
Item.createItem("ebonyBattleaxe", "\xa78Ebony battle axe", {name: "ebonyBattleaxe", meta: 0}, {stack: 1});
...
ShootLib.addGun({id: "ebonyBow", name: "Ebony bow", ammo: "ebonyArrow", accuracy: 1, recoil: 3, rate: 1, texture: {name: "ebonyBow", meta: 0}, shotType: ShotType.NORMAL, buttonType: ButtonType.TOUCH, bullet: {speed: 10, count: 1, entity: Native.EntityType.ARROW, damage: 5}, fov: {level: 5}, sounds: {shot: "BowShoot.ogg", empty: "BowGun.ogg", reload: "reload/BowReload.ogg"}});
ShootLib.addAmmo({id: "ebonyArrow", name: "Ebony arrow", texture: {name: "ebonyArrow", meta: 0}});
