...
ShootLib.addGun({id: "elvenBow", name: "Elven bow", ammo: "elvenArrow", accuracy: 1, recoil: 3, rate: 1, texture: {name: "elvenBow", meta: 0}, shotType: ShotType.NORMAL, buttonType: ButtonType.TOUCH, bullet: {speed: 10, count: 1, entity: Native.EntityType.ARROW, damage: 5}, fov: {level: 5}, sounds: {shot: "BowShoot.ogg", empty: "BowGun.ogg", reload: "reload/BowReload.ogg"}});
ShootLib.addAmmo({id: "elvenArrow", name: "Elven arrow", texture: {name: "elvenArrow", meta: 0}});
