...
ToolAPI.addToolMaterial("dragonboneBattleaxe", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ToolAPI.addToolMaterial("dragonboneWaraxe", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ToolAPI.addToolMaterial("dragonboneWarhammer", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ToolAPI.addToolMaterial("dragonboneDagger", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
ToolAPI.setTool(ItemID.dragonboneDagger, "dragonboneDagger", ToolType.sword);
IDRegistry.genItemID("dragonboneGreatsword");
Item.createItem("dragonboneGreatsword", "Dragonbone great sword", {name: "dragonboneGreatsword", meta: 0}, {stack: 1});
Item.setToolRender(ItemID.dragonboneGreatsword, true);
ToolAPI.addToolMaterial("dragonboneGreatsword", {durability: 700, level: 3, efficiency: 2, damage: 8, enchantability: 14});
...
ShootLib.addGun({id: "dragonboneBow", name: "Dragonbone bow", ammo: "dragonboneArrow", accuracy: 1, recoil: 3, rate: 1, texture: {name: "dragonboneBow", meta: 0}, shotType: ShotType.NORMAL, buttonType: ButtonType.TOUCH, bullet: {speed: 10, count: 1, entity: Native.EntityType.ARROW, damage: 5}, fov: {level: 5}, sounds: {shot: "BowShoot.ogg", empty: "BowGun.ogg", reload: "reload/BowReload.ogg"}});
ShootLib.addAmmo({id: "dragonboneArrow", name: "Dragonbone arrow", texture: {name: "dragonboneArrow", meta: 0}});
