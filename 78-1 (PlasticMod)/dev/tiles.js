TileEntity.registerPrototype(BlockID.rec_machine, {defaultValues: {progress: 0}, tick: function () {
...
TileEntity.registerPrototype(BlockID.toolBench, {defaultValues: {}, tick: function () {
    ...
    if (formSlot.id == ItemID.pickaxeForm || formSlot.id == ItemID.swordForm) {
        if (resultSlot.id == 0 || resultSlot.id == ItemID.plasticPickaxe || resultSlot.id == ItemID.plasticSword) {
            if (formSlot.id == ItemID.pickaxeForm) {
                ...
                if (formSlot.id == ItemID.swordForm) {
...
TileEntity.registerPrototype(BlockID.bomb, {destroyBlock: function (c) {
