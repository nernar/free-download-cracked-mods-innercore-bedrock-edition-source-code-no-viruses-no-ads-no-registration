LIBRARY({name: "SoundAPI", version: 1.1, shared: false, api: "CoreEngine"});
var SoundPlayers = [];
...
function AddSoundToUpdateVolume(sound, Sx, Sy, Sz, radius) {
    SoundPlayersToUpdate.push({sound: sound, x: Sx, y: Sy, z: Sz, rad: radius});
}
...
EXPORT("PlaySoundFile", PlaySoundFile);
EXPORT("StopAllSoundPlayers", StopAllSoundPlayers);
EXPORT("PlayBlockSound", PlayBlockSound);
EXPORT("StopBlockSound", StopBlockSound);
