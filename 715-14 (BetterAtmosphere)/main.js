...
Flowers.registerFlower(BlockID.mapleSapling, false);
//TileRenderer.setPlantModel(BlockID.mapleSaplingAu, 0, "maple_sapling", 1);
Flowers.registerFlower(BlockID.mapleSaplingAu, false);
//TileRenderer.setPlantModel(BlockID.mapleSaplingAuRed, 0, "maple_sapling", 2);
Flowers.registerFlower(BlockID.mapleSaplingAuRed, false);
...
Flowers.registerFlower(BlockID.autumnCrocus, false);
...
Item.registerUseFunctionForID(374, function(coords, item, block, player) {
 var Region = BlockSource.getDefaultForActor(player); 
    if (block.id == BlockID.mapleWoodSapping) {
        ...
        Region.setBlock(coords.x, coords.y, coords.z, BlockID.mapleWoodStriped, 0); 
...
Block.createBlock("foulBushmicro", [
    {name: "Foul Berry Pips", texture: [["empty", 0], ["empty", 0], ["foul_berry_bush_pips", 0]], inCreative: false}, BLOCK_TYPE_PLANT]);
...
Block.createBlock("foulBushmini", [
    {name: "Foul Berry Bush", texture: [["empty", 0], ["empty", 0], ["foul_berry_bush_stage", 1]], inCreative: false}, BLOCK_TYPE_PLANT]);
...
Block.createBlock("foulBush", [
    {name: "Foul Berry Bush", texture: [["empty", 0], ["empty", 0], ["foul_berry_bush_stage", 2]], inCreative: false}, BLOCK_TYPE_PLANT]);
...
Block.createBlock("foulBushTop", [
    {name: "Foul Berry Bush", texture: [["empty", 0], ["empty", 0], ["foul_berry_bush_stage", 3]], inCreative: false}, BLOCK_TYPE_PLANT]);
...
Block.createBlock("foulBerriedBush", [
    {name: "Foul Berry Bush", texture: [["empty", 0], ["empty", 0], ["foul_berry_bush_stage", 4]], inCreative: false}, BLOCK_TYPE_PLANT]);
...
Block.createBlock("foulBerriedBushTop", [
    {name: "Foul Berry Bush", texture: [["empty", 0], ["empty", 0], ["foul_berry_bush_stage", 5]], inCreative: false}, BLOCK_TYPE_PLANT]);
...
TileRenderer.setPlantModel(BlockID.poisonBushB, 0, "poison_bottom", 0);
  ...
  if (coords.y < 45) return;
    if(World.getBlockID(coords.x, coords.y, coords.z) == 2 && World.getBlockID(coords.x, coords.y + 1, coords.z) == 0 || BlockID.mapleLeavesAuC || BlockID.mapleLeavesAuRedC){ 
        World.setBlock(coords.x + k,coords.y+1,coords.z + k,BlockID.poisonBushB, 0);
         World.setBlock(coords.x + k,coords.y+1,coords.z + k,BlockID.poisonBush, 0);
            }
        }    
    }
} 
   
   if(Biome == 30 || Biome == 31 || Biome == 34 && random.nextFloat() < .25) {
for(var i = 0; i < 5; i++) {
  ...
  if (coords.y < 45) return;
    if(World.getBlockID(coords.x, coords.y, coords.z) == 2 && World.getBlockID(coords.x, coords.y + 1, coords.z) == 0 || BlockID.mapleLeavesAuC || BlockID.mapleLeavesAuRedC){ 
        World.setBlock(coords.x + k,coords.y+1,coords.z + k,BlockID.foulBerriedBush, 0);
         World.setBlock(coords.x + k,coords.y+1,coords.z + k,BlockID.foulBerriedBushTop, 0);
            }
        }    
    }
} 
