...
Recipes.addShaped({
	...
	"#s#",
	" # "
], ['s', 399, 0, '#', VanillaItemID.gold_ingot, 0, 'g', 20, 0]);
...
Recipes.addShaped({
	...
	"#s#",
	" # "
], ['s', 399, 0, '#', VanillaItemID.gold_ingot, 0, 'g', 288, 0]);
...
Recipes.addShaped({
	...
	"#s#",
	" # "
], ['s', 399, 0, '#', VanillaItemID.gold_ingot, 0, 'g', dyeId5, isrequiredDyeData ? 5 : 0, 'c', dyeId9, isrequiredDyeData ? 9 : 0]);
...
Recipes.addShaped({
	...
	"#s#",
	" # "
], ['s', 399, 0, '#', VanillaItemID.gold_ingot, 0, 'g', 334, 0]);
...
Recipes.addShaped({
	...
	"#s#",
	" # "
], ['s', 399, 0, '#', VanillaItemID.gold_ingot, 0, 'g', 371, 0]);
...
Recipes.addShaped({
	...
	"#s#",
	" # "
], ['s', 399, 0, '#', VanillaItemID.gold_ingot, 0, 'g', 263, 0, 'c', 263, 1]);
