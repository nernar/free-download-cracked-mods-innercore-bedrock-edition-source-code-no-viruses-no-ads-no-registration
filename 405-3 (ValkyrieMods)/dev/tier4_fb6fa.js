MachineRegistry.registerPrototype(BlockID.lct4, {defaultValues: {energy: 0, esmin: Lightning_config.tier4.min, esmax: Lightning_config.tier4.max, timer: 0}, isGenerator: function () {
    return true;
