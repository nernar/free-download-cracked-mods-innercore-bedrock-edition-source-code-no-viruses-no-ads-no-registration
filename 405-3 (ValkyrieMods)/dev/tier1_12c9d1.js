MachineRegistry.registerPrototype(BlockID.lct1, {defaultValues: {energy: 0, esmin: Lightning_config.tier1.min, esmax: Lightning_config.tier1.max, timer: 0}, isGenerator: function () {
    return true;
