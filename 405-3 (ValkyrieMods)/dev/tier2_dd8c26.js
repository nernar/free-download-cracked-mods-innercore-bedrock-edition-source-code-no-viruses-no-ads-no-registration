MachineRegistry.registerPrototype(BlockID.lct2, {defaultValues: {energy: 0, esmin: Lightning_config.tier2.min, esmax: Lightning_config.tier2.max, timer: 0}, isGenerator: function () {
    return true;
