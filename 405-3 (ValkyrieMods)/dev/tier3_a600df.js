const vrmct_k_gui = {standart: {header: {text: {text: "Void Resource Miner Controller Tier 3"}}, inventory: {standart: true}, background: {standart: true}}, drawing: [{type: "bitmap", x: 640, y: 200, bitmap: "border", scale: 3.2}], elements: {"energyScale": {type: "scale", x: 640, y: 200, direction: 0, bitmap: "energy", scale: 3.2}, "textStorage": {font: {color: android.graphics.Color.WHITE, shadow: 0.6, size: 18}, type: "text", x: 640, y: 160, width: 300, height: 39, text: "Storage: "}, "storage_max": {font: {color: android.graphics.Color.WHITE, shadow: 0.6, size: 18}, type: "text", x: 640, y: 300, width: 300, height: 39, text: "Storage: "}, "consumption": {font: {color: android.graphics.Color.WHITE, shadow: 0.6, size: 18}, type: "text", x: 640, y: 330, width: 300, height: 39, text: "Storage: "}, "work_time": {font: {color: android.graphics.Color.WHITE, shadow: 0.6, size: 18}, type: "text", x: 640, y: 360, width: 300, height: 39, text: "Storage: "}, "working": {font: {color: android.graphics.Color.WHITE, shadow: 0.6, size: 18}, type: "text", x: 640, y: 390, width: 300, height: 39, text: "Storage: "}, "time_left": {font: {color: android.graphics.Color.WHITE, shadow: 0.6, size: 18}, type: "text", x: 640, y: 420, width: 300, height: 39, text: "Storage: "}}};
slots = 0;
...
MachineRegistry.registerPrototype(BlockID.vrmct3, {defaultValues: {energy_storage_max: 50000, energy_consumption: 750, work_time: 300, timer: 0}, getGuiScreen: function () {
    ...
    for (let i = 0; i < 40; i++) {
        ...
        if (!slot.id) {
            ...
            if (Item.getMaxStack(slot.id) - slot.count !== 0) {
                working = true;
                break;
            }
        }
    ...
    for (let i = 0; i < 40; i++) {
        ...
        if (!slot.id) {
            ...
            if (slot.id === items && Item.getMaxStack(slot.id) - slot.count !== 0) {
                slot.count += 1;
                working = true;
                break;
            }
    ...
    if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_black) {
        ...
        if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_red) {
            ...
            if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_green) {
                drop_item = get_random(vrm_random_green);
            } else {
                if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_brown) {
                    ...
                    if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_blue) {
                        ...
                        if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_purple) {
                            ...
                            if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_cyan) {
                                ...
                                if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_light_gray) {
                                    drop_item = get_random(vrm_random_light_gray);
                                } else {
                                    if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_gray) {
                                        drop_item = get_random(vrm_random_gray);
                                    } else {
                                        if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_pink) {
                                            ...
                                            if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_lime) {
                                                ...
                                                if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_yellow) {
                                                    ...
                                                    if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_light_blue) {
                                                        drop_item = get_random(vrm_random_light_blue);
                                                    } else {
                                                        if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_magenta) {
                                                            drop_item = get_random(vrm_random_magenta);
                                                        } else {
                                                            if (World.getBlock(this.x, this.y - 4, this.z).id === BlockID.laser_lens_orange) {
