MachineRegistry.registerPrototype(BlockID.lct3, {defaultValues: {energy: 0, esmin: Lightning_config.tier3.min, esmax: Lightning_config.tier3.max, timer: 0}, isGenerator: function () {
    return true;
