MachineRegistry.registerPrototype(BlockID.lct6, {defaultValues: {energy: 0, esmin: Lightning_config.tier6.min, esmax: Lightning_config.tier6.max, timer: 0}, isGenerator: function () {
    return true;
