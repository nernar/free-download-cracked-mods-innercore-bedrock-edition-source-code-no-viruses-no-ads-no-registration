var base_block_envtech = Block.createSpecialType({base: 20, lightopacity: 15, destroytime: 3});
var light_block_envtech = Block.createSpecialType({base: 20, lightlevel: 6, destroytime: 3});
var opacity_block_envtech = Block.createSpecialType({renderlayer: 1, destroytime: 3});
var GUI_SCALE = 3.2;
IMPORT("flags");
IMPORT("ToolType");
IMPORT("energylib");
