const ValkyrieLib = {addRuTranslation: function (name, newname) {
    ...
    Callback.addCallback("PostLoaded", function () {
        if (dyedata == 16) {
            Recipes.addShaped({id: ItemID[itemid], count: 1, data: 0}, ["b b", "bbb", "b b"], ["b", 20, 0]);
        } else {
            if (dyedata == 17) {
                Recipes.addShaped({id: ItemID[itemid], count: 1, data: 0}, ["b b", "bab", "b b"], ["a", BlockID.normal_block_erodium, -1, "b", 20, 0]);
            } else {
                Recipes.addShaped({id: ItemID[itemid], count: 1, data: 0}, ["ab", "", ""], ["a", ItemID.lens_clear, 0, "b", 351, dyedata]);
            }
        }
    });
    ...
    model.addBox(0 / 16, 4 / 16, 0 / 16, 1 / 16, 16 / 16, 1 / 16, [[t1, 0]]);
    model.addBox(0 / 16, 4 / 16, 15 / 16, 1 / 16, 16 / 16, 16 / 16, [[t2, 0]]);
    model.addBox(15 / 16, 4 / 16, 15 / 16, 16 / 16, 16 / 16, 16 / 16, [[t2, 0]]);
    model.addBox(15 / 16, 4 / 16, 0 / 16, 16 / 16, 16 / 16, 1 / 16, [[t1, 0]]);
    model.addBox(1 / 16, 15 / 16, 0 / 16, 15 / 16, 16 / 16, 1 / 16, [[t2, 0]]);
    model.addBox(1 / 16, 15 / 16, 15 / 16, 15 / 16, 16 / 16, 16 / 16, [[t2, 0]]);
    model.addBox(0 / 16, 15 / 16, 1 / 16, 1 / 16, 16 / 16, 15 / 16, [[t2, 0]]);
    model.addBox(15 / 16, 15 / 16, 1 / 16, 16 / 16, 16 / 16, 15 / 16, [[t2, 0]]);
    model.addBox(0 / 16, 0 / 16, 0 / 16, 16 / 16, 4 / 16, 16 / 16, [[base, 0]]);
    model.addBox(2 / 16, 4 / 16, 2 / 16, 14 / 16, 7 / 16, 14 / 16, [[core, 0]]);
    model.addBox(3 / 16, 7 / 16, 3 / 16, 13 / 16, 11 / 16, 13 / 16, [[anim, 0]]);
    model.addBox(2 / 16, 11 / 16, 2 / 16, 14 / 16, 14 / 16, 14 / 16, [[core, 0]]);
    render.addEntry(model);
    ...
    model.addBox(0 / 16, 4 / 16, 0 / 16, 1 / 16, 16 / 16, 1 / 16, [[t2, 0]]);
    model.addBox(0 / 16, 4 / 16, 15 / 16, 1 / 16, 16 / 16, 16 / 16, [[t2, 0]]);
    model.addBox(15 / 16, 4 / 16, 15 / 16, 16 / 16, 16 / 16, 16 / 16, [[t2, 0]]);
    model.addBox(15 / 16, 4 / 16, 0 / 16, 16 / 16, 16 / 16, 1 / 16, [[t2, 0]]);
    model.addBox(1 / 16, 15 / 16, 0 / 16, 15 / 16, 16 / 16, 1 / 16, [[t2, 0]]);
    model.addBox(1 / 16, 15 / 16, 15 / 16, 15 / 16, 16 / 16, 16 / 16, [[t2, 0]]);
    model.addBox(0 / 16, 15 / 16, 1 / 16, 1 / 16, 16 / 16, 15 / 16, [[t2, 0]]);
    model.addBox(15 / 16, 15 / 16, 1 / 16, 16 / 16, 16 / 16, 15 / 16, [[t2, 0]]);
    model.addBox(6 / 16, 4 / 16, 0 / 16, 10 / 16, 15 / 16, 4 / 16, [[t3, 0]]);
    model.addBox(6 / 16, 4 / 16, 12 / 16, 10 / 16, 15 / 16, 16 / 16, [[t3, 0]]);
    model.addBox(12 / 16, 4 / 16, 6 / 16, 16 / 16, 15 / 16, 10 / 16, [[t3, 0]]);
    model.addBox(0 / 16, 4 / 16, 6 / 16, 4 / 16, 15 / 16, 10 / 16, [[t3, 0]]);
    model.addBox(0 / 16, 0 / 16, 0 / 16, 16 / 16, 4 / 16, 16 / 16, [[t1, 0]]);
    model.addBox(1 / 16, 15 / 16, 6 / 16, 15 / 16, 16 / 16, 10 / 16, [[t3, 0]]);
    model.addBox(6 / 16, 15 / 16, 1 / 16, 10 / 16, 16 / 16, 6 / 16, [[t3, 0]]);
    model.addBox(6 / 16, 15 / 16, 10 / 16, 10 / 16, 16 / 16, 15 / 16, [[t3, 0]]);
    model.addBox(4 / 16, 4 / 16, 4 / 16, 12 / 16, 9 / 16, 12 / 16, [[t1, 0]]);
    render.addEntry(model);
    BlockRenderer.setStaticICRender(BlockID[block], 0, render);
    ...
    model.addBox(0 / 16, 12 / 16, 0 / 16, 16 / 16, 16 / 16, 16 / 16, [[t2, 0], [t2, 0], [t2, 0]]);
    model.addBox(0 / 16, 0 / 16, 0 / 16, 1 / 16, 12 / 16, 1 / 16, [[t1, 0]]);
    model.addBox(0 / 16, 0 / 16, 15 / 16, 1 / 16, 12 / 16, 16 / 16, [[t1, 0]]);
    model.addBox(15 / 16, 0 / 16, 0 / 16, 16 / 16, 12 / 16, 1 / 16, [[t1, 0]]);
    model.addBox(15 / 16, 0 / 16, 15 / 16, 16 / 16, 12 / 16, 16 / 16, [[t1, 0]]);
    model.addBox(1 / 16, 0 / 16, 0 / 16, 15 / 16, 1 / 16, 1 / 16, [[t1, 0]]);
    model.addBox(1 / 16, 0 / 16, 15 / 16, 15 / 16, 1 / 16, 16 / 16, [[t1, 0]]);
    model.addBox(0 / 16, 0 / 16, 1 / 16, 1 / 16, 1 / 16, 15 / 16, [[t1, 0]]);
    model.addBox(15 / 16, 0 / 16, 1 / 16, 16 / 16, 1 / 16, 15 / 16, [[t1, 0]]);
    model.addBox(2 / 16, 2 / 16, 2 / 16, 14 / 16, 12 / 16, 14 / 16, [[t1, 0], [t1, 0], [t3, 0]]);
    render.addEntry(model);
    BlockRenderer.setStaticICRender(BlockID[block], 0, render);
    Block.setBlockShape(BlockID[block], {x: 0, y: 0, z: 0}, {x: 1, y: 1, z: 1});
    ...
    model.addBox(0 / 16, 0 / 16, 1 / 16, 1 / 16, 1 / 16, 15 / 16, [[t1, 0]]);
    model.addBox(15 / 16, 0 / 16, 1 / 16, 16 / 16, 1 / 16, 15 / 16, [[t1, 0]]);
    model.addBox(2 / 16, 6 / 16, 2 / 16, 14 / 16, 12 / 16, 14 / 16, [[t1, 0], [t1, 0], [t3, 0]]);
    model.addBox(5 / 16, 1 / 16, 4 / 16, 11 / 16, 6 / 16, 5 / 16, [[t1, 0], [t1, 0], [t3, 0]]);
    model.addBox(5 / 16, 1 / 16, 11 / 16, 11 / 16, 6 / 16, 12 / 16, [[t1, 0], [t1, 0], [t3, 0]]);
    model.addBox(11 / 16, 1 / 16, 5 / 16, 12 / 16, 6 / 16, 11 / 16, [[t1, 0], [t1, 0], [t3, 0]]);
    model.addBox(4 / 16, 1 / 16, 5 / 16, 5 / 16, 6 / 16, 1 / 16, [[t1, 0], [t1, 0], [t3, 0]]);
    model.addBox(5 / 16, 0 / 16, 5 / 16, 11 / 16, 1 / 16, 11 / 16, [[t1, 0], [t1, 0], [t1, 0]]);
    model.addBox(5.5 / 16, 0.5 / 16, 5.5 / 16, 11.5 / 16, 1.5 / 16, 11.5 / 16, [[t1, 0], [t1, 0], [t1, 0]]);
    render.addEntry(model);
    BlockRenderer.setStaticICRender(BlockID[block], 0, render);
    Block.setBlockShape(BlockID[block], {x: 0, y: 0, z: 0}, {x: 1, y: 1, z: 1});
...
str:
    for (let i in structure) {
        if (World.getBlock(c.x + structure[i].x, c.y + structure[i].y, c.z + structure[i].z).id !== structure[i].id) {
            for (let u = 9; u < 45; u++) {
                ...
                if (item.id === structure[i].id) {
                    ...
                    if (u == 45) {
                        p = 1;
                        Game.message("Not Enough (> " + structure[i].id + " <) for assemble structure");
                        break str;
                    }
                }
            }
        ...
        if (i == structure.length) {
            if (p == 0) {
                Game.message("Structure Assembler finished work");
            } else {
                if (p == 1) {
                    Game.message("Structure Assembler finished work with error");
                }
            }
        }
    }
        ...
        for (let u = 9; u < 45; u++) {
            ...
            if (item.id === structure[i].id) {
                ...
                if (item.id == 0) {
                    ...
                    if (u == 45) {
                        World.drop(c.x, c.y + 1, c.z, structure[i].id, 1, 0);
                        World.setBlock(structure[i].x + c.x, structure[i].y + c.y, structure[i].z + c.z, 0);
                    }
                }
            }
