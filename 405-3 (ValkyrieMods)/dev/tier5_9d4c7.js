MachineRegistry.registerPrototype(BlockID.lct5, {defaultValues: {energy: 0, esmin: Lightning_config.tier5.min, esmax: Lightning_config.tier5.max, timer: 0}, isGenerator: function () {
    return true;
