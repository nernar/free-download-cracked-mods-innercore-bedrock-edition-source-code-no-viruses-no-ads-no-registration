...
MachineRegistry.registerPrototype(BlockID.vrmct2, {defaultValues: {energy_storage_max: 50000, energy_consumption: 575, work_time: 400, timer: 0}, getGuiScreen: function () {
    ...
    if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_black) {
        ...
        if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_red) {
            ...
            if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_green) {
                drop_item = get_random(vrm_random_green);
            } else {
                if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_brown) {
                    ...
                    if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_blue) {
                        ...
                        if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_purple) {
                            ...
                            if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_cyan) {
                                ...
                                if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_light_gray) {
                                    drop_item = get_random(vrm_random_light_gray);
                                } else {
                                    if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_gray) {
                                        drop_item = get_random(vrm_random_gray);
                                    } else {
                                        if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_pink) {
                                            ...
                                            if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_lime) {
                                                ...
                                                if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_yellow) {
                                                    ...
                                                    if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_light_blue) {
                                                        drop_item = get_random(vrm_random_light_blue);
                                                    } else {
                                                        if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_magenta) {
                                                            drop_item = get_random(vrm_random_magenta);
                                                        } else {
                                                            if (World.getBlock(this.x, this.y - 3, this.z).id === BlockID.laser_lens_orange) {
