var BlockType = {registerDoors: function (UP, valueUP, DOWN, valueDOWN, doorID, doors) {
    IDRegistry.genBlockID(UP + "closeUP");
    Block.createBlockWithRotation(UP + "closeUP", [{name: "NoNe", texture: [[valueUP.texture_bottom, 0], [valueUP.texture_top, 0], [valueUP.texture_back, 0], [valueUP.texture_front, 0], [valueUP.texture_left, 0], [valueUP.texture_right, 0]], inCreative: false}]);
    Block.setBlockShape(BlockID[UP + "closeUP"], {x: 0, y: 0, z: 0}, {x: 1, y: 1, z: +0.19});
    IDRegistry.genBlockID(UP + "OpenUP");
    Block.createBlockWithRotation(UP + "OpenUP", [{name: "NoNe", texture: [[valueUP.texture_bottom, 0], [valueUP.texture_top, 0], [valueUP.texture_right, 0], [valueUP.texture_left, 0], [valueUP.texture_back, 0], [valueUP.texture_front, 0]], inCreative: false}]);
    Block.setBlockShape(BlockID[UP + "OpenUP"], {x: 0, y: 0, z: 0}, {x: 0.19, y: 1, z: +1});
    IDRegistry.genBlockID(DOWN + "closeDOWN");
    Block.createBlockWithRotation(DOWN + "closeDOWN", [{name: "NoNe", texture: [[valueDOWN.texture_bottom, 0], [valueDOWN.texture_top, 0], [valueDOWN.texture_back, 0], [valueDOWN.texture_front, 0], [valueDOWN.texture_left, 0], [valueDOWN.texture_right, 0]], inCreative: false}]);
    Block.setBlockShape(BlockID[DOWN + "closeDOWN"], {x: 0, y: 0, z: 0}, {x: 1, y: 1, z: +0.19});
    IDRegistry.genBlockID(DOWN + "OpenDOWN");
    Block.createBlockWithRotation(DOWN + "OpenDOWN", [{name: "NoNe", texture: [[valueDOWN.texture_bottom, 0], [valueDOWN.texture_top, 0], [valueDOWN.texture_right, 0], [valueDOWN.texture_left, 0], [valueDOWN.texture_back, 0], [valueDOWN.texture_front, 0]], inCreative: false}]);
    Block.setBlockShape(BlockID[DOWN + "OpenDOWN"], {x: 0, y: 0, z: 0}, {x: 0.19, y: 1, z: +1});
    TileEntity.registerPrototype(BlockID[UP + "closeUP"], {tick: function () {
    ...
    TileEntity.registerPrototype(BlockID[UP + "OpenUP"], {tick: function () {
        if ((World.getBlock(this.x, this.y - 1, this.z).id == BlockID[DOWN + "OpenDOWN"]) || (World.getBlock(this.x, this.y - 1, this.z).id == BlockID[DOWN + "closeDOWN"])) {
        } else {
            alert(1);
            World.destroyBlock(this.x, this.y, this.z, false);
    ...
    TileEntity.registerPrototype(BlockID[DOWN + "OpenDOWN"], {click: function () {
        World.setBlock(this.x, this.y, this.z, BlockID[DOWN + "closeDOWN"], 0);
        World.setBlock(this.x, this.y + 1, this.z, BlockID[UP + "closeUP"], 0);
    }});
    TileEntity.registerPrototype(BlockID[DOWN + "closeDOWN"], {click: function () {
    ...
    Block.createBlockWithRotation(id, [{name: value.name, texture: [[value.texture_bottom, 0], [value.texture_top, 0], [value.texture_back, 0], [value.texture_front, 0], [value.texture_left, 0], [value.texture_right, 0]], inCreative: true}]);
    Block.setBlockShape(BlockID[id], {x: 0, y: 0.82, z: 0}, {x: 1, y: 1, z: 1});
    IDRegistry.genBlockID(id + "open");
    Block.createBlockWithRotation(id + "open", [{name: value.name, texture: [[value.texture_back, 0], [value.texture_front, 0], [value.texture_bottom, 0], [value.texture_top, 0], [value.texture_left, 0], [value.texture_right, 0]], inCreative: false}]);
    Block.setBlockShape(BlockID[id + "open"], {x: 0, y: 0, z: 0}, {x: 0.18, y: 1, z: 1});
    TileEntity.registerPrototype(BlockID[id], {click: function () {
        World.setBlock(this.x, this.y, this.z, BlockID[id + "open"], 0);
    }});
    TileEntity.registerPrototype(BlockID[id + "open"], {click: function () {
    ...
    if (enable == true) {
        ...
        hide.addEntry(mod);
        TileEntity.registerPrototype(id, {tick: function () {
