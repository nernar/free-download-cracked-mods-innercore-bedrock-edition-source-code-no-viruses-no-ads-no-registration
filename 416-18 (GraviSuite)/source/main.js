...
var AdvancedNanoChestplate = /** @class */ (function (_super) {
    ...
    AdvancedNanoChestplate.prototype.onTick = function (item, index, playerUid) {
        var stack = JetpackProvider.onTick(item, playerUid);
...
var GraviChestplate = /** @class */ (function (_super) {
    ...
    function GraviChestplate() {
        var _this = _super.call(this, "graviChestplate", "gravi_chestplate", { type: "chestplate", defence: 9, knockbackResistance: 2, texture: "graviChestplate" }, false) || this;
...
var AdvancedDrill = /** @class */ (function (_super) {
    ...
    AdvancedDrill.prototype.readMode = function (extra) {
        return (extra === null || extra === void 0 ? void 0 : extra.getInt("mode")) || 0;
    };
    ...
    AdvancedDrill.prototype.destroy3x3Area = function (coords, player, energyStored) {
...
var GraviTool = /** @class */ (function (_super) {
    ...
    GraviTool.prototype.onNameOverride = function (item, name) {
        var mode = this.readMode(item.extra);
        name += " (".concat(Translation.translate(this.getModeName(mode)), ")");
    ...
    GraviTool.prototype.onItemUse = function (coords, item, block, player) {
        ...
        if (mode == 0 && (block.id == 2 || block.id == 3 || block.id == 110 || block.id == 243) && coords.side != 0 && ICore.Tool.useElectricItem(item, 50, player)) {
            ...
            Entity.setVelocity(region.dropItem(coords.relative.x + 0.5, coords.relative.y + 0.5, coords.relative.z + 0.5, ItemID.latex, MathUtil.randomInt(1, 3), 0), (coords.relative.x - coords.x) * 0.25, (coords.relative.y - coords.y) * 0.25, (coords.relative.z - coords.z) * 0.25);
        }
    };
    return GraviTool;
}(ElectricTool));
