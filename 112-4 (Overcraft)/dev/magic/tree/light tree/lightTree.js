...
/////////////////////////////////////////////Саплинг
IDRegistry.genItemID("lightmagicTree");
Item.createItem("lightmagicTree", "Light magic tree", {name: "lightmagicWood_sapling", meta: 0}, {stack: 64});
////////////////////////////////////////////Древесина
...
IDRegistry.genBlockID("LightMagicLeaves");
Block.createBlock("LightMagicLeaves", [
	{name: "Light Magic Leaves", texture: [["light_tree_leaves", 0]], inCreative: true}
], BLOCK_TYPE_LEAVES);
Block.registerDropFunction("LightMagicLeaves", function(){
	if(Math.random() < .055){
		return [[ItemID.lightmagicTree, 1, 0]]
	}
	else {
		return [];
	}
});
ToolAPI.registerBlockMaterial(BlockID.LightMagicLeaves, "plant");
///////////////////////////////////////////////////////////////////////////////
var LightTreeGenerationHelper = {
	/*
	 params: {
		 leaves: {
			 id: 
...
Item.registerUseFunction("lightmagicTree", function(coords, item, tile){
...
IDRegistry.genBlockID("lightmagicTree");
Block.createBlock("lightmagicTree", [
	{name: "Light magic tree", texture: [["empty", 0], ["empty", 0], ["empty", 0], ["empty", 0], ["empty", 0], ["empty", 0]], inCreative: false}
]);

Block.setBlockShape(BlockID.lightmagicTree, {x: 0.001, y: 0.001, z: 0.001}, {x: 0.999, y: 0.1, z: 0.999});
...
TileEntity.registerPrototype(BlockID.magicTree, {
	...
	checkGrowth: function(){
		...
		if (this.data.growth > 512){
			this.selfDestroy();
     LightTreeGenerationHelper.generateTree(this.x, this.y, this.z, true);
		}
	}
});
//////////////////////////////////////////////////////////////////////////////////////////
