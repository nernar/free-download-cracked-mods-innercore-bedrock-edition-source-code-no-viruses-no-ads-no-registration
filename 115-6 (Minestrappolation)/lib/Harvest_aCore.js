...
var HarvestConfig = {values: {StandartAge: 0, ageSpeed: 0.0001}, debug: {CropPROTO: false}, set: {value: {standartAge: function (value) {
    this.values.StandartAge = value;
}, standartAgeSpeed: function (value) {
    this.values.ageSpeed = value;
}}}};
var Harvest = {dropWithoutDirt: {}, registerDroppingBlock: function (iiid) {
...
var TREE_SAPLING_GROUND_TILES = {2: true, 3: true, 60: true};
var CropRegistry = {cropsIDs: {}, cropsDrop: {}, seedCrops: {}, cropSeed: {}, registerWithID: function (blockID, name, texture, seed) {
    IDRegistry.genBlockID(blockID);
    Block.createBlock(blockID, [{name: name, texture: [["empty", 0], ["empty", 0], [texture, 0]], inCreative: false}, {name: name, texture: [["empty", 0], ["empty", 0], [texture, 1]], inCreative: false}, {name: name, texture: [["empty", 0], ["empty", 0], [texture, 2]], inCreative: false}], BLOCK_TYPE_CROP);
...
var cropPROTO = {isCrop: true, defaultValues: {age: 0, fruit: 280, seed: 0}, growCrop: function () {
    this.data.age++;
...
var fruitPROTO = {defaultValues: {age: 0, fruit: 280}, tick: function () {
...
var saplingPROTO = {tick: function () {
...
var gardenPROTO = {defaultValues: {drop: 280}, created: function () {
