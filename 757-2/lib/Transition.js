LIBRARY({name: "Transition", version: 6, shared: true, api: "AdaptedScript", dependencies: ["Retention:4"]});
IMPORT("Retention:4");
    ...
    if (params) {
        if (typeof params == "object") {
            ...
            if (typeof params == "number") {
                ...
                MCSystem.throwException("Transition can't be created with invalid type of params");
            }
        }
    }
        ...
        this.thread = handleThread(function () {
            tryout(function () {
                ...
                if (e.message == "java.lang.InterruptedException: null") {
                    ...
                    if (e.message == "Cannot call method \"isInterrupted\" of undefined") {
                        return;
                    }
                }
                reportError(e);
...
Transition.compareVectorPoint = function (frame, request) {
    ...
    return {x: frame[0] * speedest, y: frame[1] * speedest, z: frame[2] * speedest, yaw: frame[3] * speedest, pitch: frame[4] * speedest};
};
