...
TransitionConverter.prototype.buildFrame = function (frame) {
    return MathUtils.mathDivider(frame.x) + ", " + MathUtils.mathDivider(frame.y) + ", " + MathUtils.mathDivider(frame.z) + (frame.yaw !== undefined ? ", " + MathUtils.mathDivider(frame.yaw) : new String()) + (frame.pitch !== undefined ? ", " + MathUtils.mathDivider(frame.pitch) : new String()) + (frame.duration !== undefined ? ", " + frame.duration : new String()) + (frame.interpolator !== undefined ? ", " + this.resolveInterpolator(frame.interpolator) : new String());
};
