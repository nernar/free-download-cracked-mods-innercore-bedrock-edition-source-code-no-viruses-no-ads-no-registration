LIBRARY({name: "DungeonCore", version: 2, api: "CoreEngine"});
var Dungeon = {path: "/structure/", getId: function (id) {
    if (typeof id == "string") {
        return BlockID[id];
    } else {
        return id;
    ...
    return {id: (function (id) {
        ...
        return Block;
    })(string.split(".")[0]), data: parseInt(string.split(".")[1]), x: parseInt(string.split(".")[2]), y: parseInt(string.split(".")[3]), z: parseInt(string.split(".")[4])};
}, advanced: function (name) {
    this.stru = FileTools.ReadJSON(__dir__ + Dungeon.path + name + ".dc");
    this.prot = {isSetBlock: function (x, y, z, id, data, identifier, region, state, packet) {
        return true;
    ...
    this.setStructure = function (x, y, z, region, packet) {
        ...
        for (let i in this.stru) {
            if (this.prot.isSetBlock(parseInt(this.stru[i][1].split(".")[1]) + x, parseInt(this.stru[i][1].split(".")[2]) + y, parseInt(this.stru[i][1].split(".")[3]) + z, Dungeon.getId(this.stru[i][0]), parseInt(this.stru[i][1].split(".")[0]), Dungeon.generateIdentifier({id: Dungeon.getId(this.stru[i][0]), data: parseInt(this.stru[i][1].split(".")[0]), x: parseInt(this.stru[i][1].split(".")[1]) + x, y: parseInt(this.stru[i][1].split(".")[2]) + y, z: parseInt(this.stru[i][1].split(".")[3]) + z}), region, new BlockState(Dungeon.getId(this.stru[i][0]), this.stru[i][2]), packet)) {
                ...
                if (this.stru[i][3]) {
                    region.setExtraBlock(parseInt(this.stru[i][1].split(".")[1]) + x, parseInt(this.stru[i][1].split(".")[2]) + y, parseInt(this.stru[i][1].split(".")[3]) + z, new BlockState(Dungeon.getId(this.stru[i][3][0]), this.stru[i][3][1]));
                }
            }
            this.prot.setBlock(parseInt(this.stru[i][1].split(".")[1]) + x, parseInt(this.stru[i][1].split(".")[2]) + y, parseInt(this.stru[i][1].split(".")[3]) + z, Dungeon.getId(this.stru[i][0]), parseInt(this.stru[i][1].split(".")[0]), Dungeon.generateIdentifier({id: Dungeon.getId(this.stru[i][0]), data: parseInt(this.stru[i][1].split(".")[0]), x: parseInt(this.stru[i][1].split(".")[1]) + x, y: parseInt(this.stru[i][1].split(".")[2]) + y, z: parseInt(this.stru[i][1].split(".")[3]) + z}), region, new BlockState(Dungeon.getId(this.stru[i][0]), this.stru[i][2]), packet);
        }
    ...
    for (let i in stru) {
        ...
        if (stru[i][3]) {
            region.setExtraBlock(parseInt(stru[i][1].split(".")[1]) + x, parseInt(stru[i][1].split(".")[2]) + y, parseInt(stru[i][1].split(".")[3]) + z, new BlockState(Dungeon.getId(stru[i][3][0]), stru[i][3][1]));
        }
    }
}, isBlock: function (id) {
    let d;
...
var TYPE = {helmet: [{e: 0, l: 4}, {e: 1, l: 4}, {e: 3, l: 4}, {e: 4, l: 4}, {e: 5, l: 3}, {e: 6, l: 3}, {e: 8, l: 1}, {e: 17, l: 3}], chestplate: [{e: 0, l: 4}, {e: 1, l: 4}, {e: 3, l: 4}, {e: 4, l: 4}, {e: 5, l: 3}, {e: 17, l: 3}], leggings: [{e: 0, l: 4}, {e: 1, l: 4}, {e: 3, l: 4}, {e: 4, l: 4}, {e: 5, l: 3}, {e: 17, l: 3}], boots: [{e: 0, l: 4}, {e: 1, l: 4}, {e: 2, l: 4}, {e: 3, l: 4}, {e: 4, l: 4}, {e: 5, l: 3}, 7, {e: 17, l: 3}], sword: [{e: 9, l: 5}, {e: 10, l: 5}, {e: 11, l: 5}, {e: 12, l: 2}, {e: 13, l: 2}, {e: 14, l: 3}, {e: 17, l: 3}], shovel: [{e: 15, l: 5}, {e: 16, l: 1}, {e: 17, l: 3}, {e: 18, l: 3}], pickaxe: [{e: 15, l: 5}, {e: 16, l: 1}, {e: 17, l: 3}, {e: 18, l: 3}], axe: [{e: 9, l: 5}, {e: 10, l: 5}, {e: 11, l: 5}, {e: 15, l: 5}, {e: 16, l: 1}, {e: 17, l: 3}, {e: 18, l: 3}], hoe: [{e: 17, l: 3}], bow: [{e: 17, l: 3}, {e: 19, l: 5}, {e: 18, l: 2}, {e: 21, l: 1}, {e: 22, l: 1}], fishing: [{e: 17, l: 3}, {e: 23, l: 3}, {e: 24, l: 3}], shears: [{e: 15, l: 5}, {e: 17, l: 3}]};
function ItemGeneration() {
    this.items = [];
    this.prot = {before: function (pos, region, packet) {
    }, after: function (pos, region, packet) {
    }, isGenerate: function (pos, random, slot, item, region, packet) {
        return true;
    ...
    this.setPrototype = function (obj) {
        ...
        if (!obj.isGenerate) {
            obj.isGenerate = function (pos, random, slot, item, region, packet) {
                return true;
            };
        }
        if (!obj.generate) {
            obj.generate = function (pos, random, slot, item, region, packet) {
            };
        }
        this.prot = obj;
    };
        ...
        if (cont) {
            ...
            for (let i in this.items) {
                ...
                if (random <= this.items[i][1]) {
                    ...
                    let item = {id: this.items[i][0], data: this.items[i][3], extra: this.items[i][4]};
                    if (this.prot.isGenerate({x: x, y: y, z: z}, random, slot, item, region, packet)) {
                        cont.setSlot(slot, item.id, count, item.data, item.extra);
                    }
        ...
        if (cont) {
            ...
            for (let i in this.items) {
                ...
                if (rand <= this.items[i][1]) {
                    ...
                    let item = {id: this.items[i][0], data: this.items[i][3], extra: this.items[i][4]};
                    if (this.prot.isGenerate({x: x, y: y, z: z}, rand, slot, item, region, packet)) {
                        cont.setSlot(slot, item.id, count, item.data, item.extra);
                    }
...
var ItemGenerate = {defaults: ItemGeneration, advanced: ItemGenerationPro, enchantAdd: function (type, count) {
    let arr = TYPE[type];
...
var Utility = {random: function () {
    return new java.util.Random();
}, setStruc: function (name, coords, region) {
    region = region || BlockSource.getCurrentWorldGenRegion();
    Dungeon.setStructure(name, coords.x, coords.y, coords.z, region);
}, gntId: Dungeon.generateIdentifier, setBlockWater: function (x, y, z, id, data, region) {
    data = data || 0;
    region = region || BlockSource.getCurrentWorldGenRegion();
...
Callback.addCallback("NativeCommand", function (str) {
    let cmd = str.split(" ");
    if (cmd[0] == "/tools") {
        Game.message("\xa72\u0432\u044b\u0434\u0430\u043d \u0438\u043d\u0441\u0442\u0440\u0443\u043c\u0435\u043d\u0442");
    ...
    if (cmd[0] == "/structures") {
        if (cmd[1] == "write") {
            ...
            Game.message("\xa72\u0441\u0442\u0440\u0443\u043a\u0442\u0443\u0440\u0430 \u0441\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u0430");
            blockArray = [];
        }
    }
});
