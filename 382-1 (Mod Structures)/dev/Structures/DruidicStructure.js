...
DruidicStructure.addItems(ItemID.coldsteel, 0.1, {max:2});
DruidicStructure.addItems(ItemID.coldnordicgold, 0.05, {max:2});
DruidicStructure.addItems(ItemID.coldtitanium, 0.1, {max:2});

DruidicStructure.addItems(ItemID.cruciblepro, 0.8, {max:3});

DruidicStructure.addItems(ItemID.cruciblepro4, 0.7, {max:3});
DruidicStructure.addItems(ItemID.cruciblex, 0.8, {max:3});

DruidicStructure.addItems(ItemID.cruciblex2, 0.7, {max:3});
